...
| TC-028 | Roadmap policy states a high corpus failure rate pauses promotion rather than weakening the contract | Manual | P0 | FR-007-CON-2 | ✅ architecture review passed |
