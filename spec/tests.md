...
| TC-1313 | cases.json differs from the base only by spec-bundle and reason members, the rewritten top-level $comment, and the added records-and-scalars case; every pre-existing shared/** path and the spec-bundle seam file are byte-unchanged | Static | P1 | NFR-032-AC-4 | 🚧 planned |
