...
| TC-1373 | A required `0..*` field admits a present empty collection and refuses an absent member; a required `0..*` field and an optional `1..*` field are both valid `1.2.0` fields | Unit | P0 | FR-106-AC-1, FR-106-CON-1 | ✅ passed |
...
| TC-1553 | An unconstrained value and a zero-field record produce distinct IR documents and distinct generated declarations, and compare unequal at every layer | Unit | P0 | FR-139-AC-2, FR-139-CON-1 | ✅ passed |
