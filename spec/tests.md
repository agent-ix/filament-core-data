...
| TC-1322 | quire-rs is a git dep at exact rev 92dbebc with no branch, ix-trace-rs dev at v0.1.1, semantic-ir by path, serde pins exact, sha2 and clap exact, no jsonschema, no outside path/file/link dep; module PROVENANCE names 7b7b0bc | Static | P1 | NFR-033-AC-3 | ✅ passed |
