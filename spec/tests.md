...
The Producer interface 1.2.0 design pass then allocated TC-1600..1499, reserved
and confirmed unused on every remote branch before the pass began. The block is
split so the two halves are legible at a glance. TC-1600..1456 carry the static
...
namespace that four of the NFR-036 rows depend on. TC-1657..1499 carry the
...
that no row combines: TC-1633 missing identities, TC-1601 and TC-1602 digest
domain substitution and digest mismatch, TC-1607 revision namespace
substitution, TC-1624 foreign or cross-bound exports, TC-1620 endpoint role and
multiplicity loss, TC-1614 absent component and endpoint provenance, TC-1625
changed selection under a retained correspondence, and TC-1615 incomplete
...
grouped into four by measurement apparatus. One row, TC-1662, absorbs six
...
| US-016 | US-016-EX-1 (illustrative) implemented by FR-117 and FR-120 | TC-1631, TC-1638, TC-1667 | ✅ Complete |
...
| US-017 | US-017-EX-4 (illustrative) implemented by FR-126 | TC-1693 | 🚧 planned — #95 assessment half, not in this increment |
| US-017 | Assessment boundary implemented by FR-119..FR-126 and NFR-037 | TC-1657..TC-1699 | 🚧 planned — #95 assessment half, not in this increment |
...
| FR-112 | FR-112-AC-1..7, FR-112-CON-1..5 | TC-1600..TC-1605 | ✅ Complete |
| FR-113 | FR-113-AC-1..6, FR-113-CON-1..5 | TC-1606..TC-1610 | ✅ Complete |
| FR-114 | FR-114-AC-1..5, FR-114-CON-1..6 | TC-1611..TC-1616 | ✅ Complete |
| FR-115 | FR-115-AC-1..5, FR-115-CON-1..5 | TC-1617..TC-1622 | ✅ Complete |
| FR-116 | FR-116-AC-1..9, FR-116-CON-1..5 | TC-1623..TC-1630 | ✅ Complete |
| FR-117 | FR-117-AC-1..11, FR-117-CON-1..7 | TC-1631..TC-1639 | ✅ Complete |
| FR-118 | FR-118-AC-1..12, FR-118-CON-1..7 | TC-1640..TC-1649 | ✅ Complete |
| FR-119 | FR-119-AC-1..10, FR-119-CON-1..8 | TC-1657..TC-1662 | 🚧 planned — #95 assessment half, not in this increment |
| FR-120 | FR-120-AC-1..10, FR-120-CON-1..8 | TC-1663..TC-1667 | 🚧 planned — #95 assessment half, not in this increment |
| FR-121 | FR-121-AC-1..9, FR-121-CON-1..6 | TC-1668..TC-1671 | 🚧 planned — #95 assessment half, not in this increment |
| FR-122 | FR-122-AC-1..11, FR-122-CON-1..6 | TC-1672..TC-1677 | 🚧 planned — #95 assessment half, not in this increment |
| FR-123 | FR-123-AC-1..9, FR-123-CON-1..5 | TC-1678..TC-1681 | 🚧 planned — #95 assessment half, not in this increment |
...
| TC-1600 | A canonical-object digest and a native raw-byte digest are each emitted as the four-member selection whose `algorithm`, `domain`, `version`, and `value` map member-for-member onto the pinned consumer `SelectedDigest`, with `version` a separate authored member never supplied by the domain spelling | Unit | P0 | FR-112-AC-1, FR-112-CON-3 | ✅ passed |
| TC-1601 | A canonical-object digest offered under `quire-native-bytes-1` and a native raw-byte digest offered under `filament-canonical-json-1` each refuse, rather than being revalidated in the other domain | Unit | P0 | FR-112-AC-2 | ✅ passed |
| TC-1602 | A digest selection whose recomputed value differs from its declared value refuses with a blocking refusal, not a warning, a cache miss, or a refetch invitation | Unit | P0 | FR-112-AC-3 | ✅ passed |
| TC-1603 | A digest selection with an absent `version`, one whose domain or version lies outside the closed admissible vocabulary, one whose admissible pair the configuration document does not select, and a bare hash string offered in place of a selection each refuse and bind nothing | Unit | P0 | FR-112-AC-4, FR-112-AC-5, FR-112-CON-1, FR-112-CON-5 | ✅ passed |
| TC-1604 | A source-provenance locus carrying the consumer-owned `ArtifactRef.digest` raw-byte string and the consumer-owned `NativeSource.revision` authority label is admitted, and neither member refuses as a malformed digest selection | Unit | P1 | FR-112-AC-6, FR-112-CON-4 | ✅ passed |
| TC-1605 | One producer object transmitted under two different wire member orders yields one identical digest `value`, because every canonical-object digest input is the FR-118 canonicalizer output for that object rather than the producer's own serializer | Property | P0 | FR-112-AC-7, FR-112-CON-2 | ✅ passed |
| TC-1606 | Producer model, component, endpoint, and relationship revisions are emitted under `filament-core-data/producer-object-revision-1` and native artifact and definition revisions under `quire-native/definition-revision-1`, both members mapping onto the pinned consumer `Revision`, and no third namespace is emitted | Unit | P0 | FR-113-AC-1, FR-113-CON-1 | ✅ passed |
| TC-1607 | A native definition revision offered under the producer-object namespace and a producer-object revision offered under the native definition namespace each refuse | Unit | P0 | FR-113-AC-2 | ✅ passed |
| TC-1608 | A bare revision string offered in place of a two-member revision the producer authors refuses and binds nothing | Unit | P0 | FR-113-AC-3, FR-113-CON-2 | ✅ passed |
| TC-1609 | A revision namespace outside the closed admissible vocabulary refuses, and one inside it that the configuration document does not declare as a selection refuses | Unit | P0 | FR-113-AC-4, FR-113-CON-5 | ✅ passed |
| TC-1610 | Two revisions sharing one `value` spelling under the two declared namespaces remain two distinct revisions, and a locus carrying the consumer-owned `NativeSource.revision` label and `ArtifactRef.digest` string is admitted rather than refused as a malformed revision | Unit | P1 | FR-113-AC-5, FR-113-AC-6, FR-113-CON-3, FR-113-CON-4 | ✅ passed |
| TC-1611 | One component record carries its identity, namespaced revision, canonical digest selection, locus, ownership, and inventory membership as six separate members that equal spelling never merges | Unit | P0 | FR-114-AC-1, FR-114-CON-3 | ✅ passed |
| TC-1612 | One endpoint record carries the same six members and additionally names its owning component identity, its type identity, its role, and its multiplicity, none reconstructed from another | Unit | P0 | FR-114-AC-1 | ✅ passed |
| TC-1613 | A repository, a component, a role, and an endpoint sharing one display name remain four distinct identities, and no component identity is reconstructed from a path, a package name, or a deployment name | Unit | P0 | FR-114-AC-1, FR-114-CON-1, FR-114-CON-2 | ✅ passed |
| TC-1614 | A component whose locus is absent refuses, and an endpoint whose locus names no formal document revision refuses, each with a blocking refusal naming the offending record and neither substituting a native source label for the formal revision | Unit | P0 | FR-114-AC-2, FR-114-CON-4 | ✅ passed |
| TC-1615 | A component outside a closed declared inventory refuses admission, while the same component under an explicitly incomplete inventory is admitted carrying the completeness member with the retained `unknown` disposition FR-110 owns | Integration | P0 | FR-114-AC-3, FR-114-CON-6 | ✅ passed |
| TC-1616 | A full locus carrying `source` with `refVersion`, `kind`, `authority`, `identity`, a namespaced revision, one raw-byte digest string and `wire`, plus `formal` and `span`, is admitted with its raw-byte digest string, while a component whose locus no declaration source document supplies refuses and no synthesized locus is emitted | Unit | P0 | FR-114-AC-4, FR-114-AC-5, FR-114-CON-5 | ✅ passed |
| TC-1617 | One relationship record carries its identity, namespaced revision, canonical digest, authored name, `semantics` category with direction, composite flag, lifecycle and ownership, and the owning model, profile, and configuration identities as separate members | Unit | P0 | FR-115-AC-1, FR-115-CON-4 | ✅ passed |
| TC-1618 | The `source` and `target` endpoint records of one relationship each carry their own `endpointIdentity`, `typeIdentity`, `role`, and `multiplicity` as independent members even when both name one type identity | Unit | P0 | FR-115-AC-1, FR-115-CON-3 | ✅ passed |
| TC-1619 | A self-relationship whose `source` and `target` name one type identity emits two independent endpoint records retaining their own endpoint identities, roles, and multiplicities | Unit | P0 | FR-115-AC-2 | ✅ passed |
| TC-1620 | A relationship whose `source` omits its role refuses, one whose `target` omits its multiplicity refuses, and an endpoint projection collapsing the two roles into one refuses with a named loss record carrying the relationship identity rather than a guessed value | Unit | P0 | FR-115-AC-3 | ✅ passed |
| TC-1621 | Each `source` and `target` endpoint record joins a declared FR-114 endpoint through its `endpointIdentity` and never through a coinciding type identity, role, or display name, and a `source` `endpointIdentity` naming no declared endpoint refuses naming the relationship | Integration | P0 | FR-115-AC-4, FR-115-AC-5, FR-115-CON-5 | ✅ passed |
| TC-1622 | A relationship identity is authored rather than reconstructed from a foreign key, a field, or a relationship instance, and the emitted record carries no population member and no relationship instance | Unit | P0 | FR-115-CON-1, FR-115-CON-2 | ✅ passed |
| TC-1623 | One selected pair of one producer object and one native artifact yields exactly one correspondence record whose five authored producer-object members, native selection, native definition closure, binding-relation identity, configuration provenance, and export mappings are separate readable members, and whose producer object carries no authored interface member | Compile | P0 | FR-116-AC-1, FR-116-CON-1 | ✅ passed |
| TC-1624 | A correspondence record whose export mapping names an export its producer object does not export refuses, and one naming an export owned by another correspondence's producer object refuses | Unit | P0 | FR-116-AC-2 | ✅ passed |
| TC-1625 | Changing the producer object selection or the native artifact selection while retaining the prior binding relation refuses | Unit | P0 | FR-116-AC-3 | ✅ passed |
| TC-1626 | A presentation-only native re-encoding is admitted only through a new native artifact selection and a new correspondence record, never through a digest substitution under the retained relation | Unit | P0 | FR-116-AC-3 | ✅ passed |
| TC-1627 | A correspondence record submitted without the configuration provenance that authorized its relation refuses, and one whose required native definition-closure identities are incomplete refuses | Unit | P0 | FR-116-AC-4, FR-116-AC-5 | ✅ passed |
| TC-1628 | Two correspondence records naming one selected pair refuse, and a producer object the consumer does not select yields no correspondence record | Unit | P0 | FR-116-AC-6, FR-116-AC-7, FR-116-CON-4 | ✅ passed |
| TC-1629 | Every emitted export mapping carries its exporting producer object identity, its `exportKind` from the consumer's closed vocabulary, its ordered `exportPath` segments, and its formal export locus, the record carries no consumer table index and no producer-object interface index, and no export kind FR-120 partitions to the assessment side is emitted | Unit | P0 | FR-116-AC-8, FR-116-AC-9, FR-116-CON-2 | ✅ passed |
| TC-1630 | A producer canonical digest selection and a native raw-byte digest selection stay distinct members when their hash text coincides, and every consumer `u32` table index including the producer-object interface index is left unassigned | Static | P1 | FR-116-CON-3, FR-116-CON-5 | ✅ passed |
| TC-1631 | A complete static selection is admitted as one immutable typed bundle whose bundle identity, namespaced revision, canonical digest selection, producer interface version, model, profile, component and endpoint declarations, relationship records, inventory declaration, configuration document, static prerequisite closure, and correspondence records are each read directly as typed members | Unit | P0 | FR-117-AC-1 | ✅ passed |
| TC-1632 | The admitted static bundle carries no population, snapshot, window, instance, observation, progress record, or observation closure, and the bundle type is closed over exactly the declared content member classes and that exclusion and over no header member | Compile | P0 | FR-117-AC-1, FR-117-CON-1 | ✅ passed |
| TC-1633 | A bundle omitting any required member, whether a header member, an identity, a namespaced revision, a digest selection, a provenance locus, an ownership member, an inventory membership, or the static prerequisite closure, is refused and the refusal names the absent member | Unit | P0 | FR-117-AC-2 | ✅ passed |
| TC-1634 | An assessment member offered inside the static bundle refuses naming that member, an assessment document offered in place of a static admission refuses naming that document, and a correspondence export of the assessment kind FR-120 partitions to the assessment side refuses naming that export | Unit | P0 | FR-117-AC-3, FR-117-AC-7 | ✅ passed |
| TC-1635 | The static bundle type exposes no public constructor, no public member, and no deserialization path that bypasses admission, so no unvalidated value of the type can be constructed and a refused admission yields no value | Compile | P0 | FR-117-AC-4, FR-117-CON-2 | ✅ passed |
| TC-1636 | A static admission run with altered environment variables, an altered working directory, an altered wall clock, and no network reachability produces the identical admitted bundle | Integration | P0 | FR-117-AC-5, FR-117-CON-3 | ✅ passed |
| TC-1637 | Every member of an admitted static bundle is read without parsing prose, defaulting a member, or inferring a field, and production of the bundle is recorded as static admission only rather than as campaign acceptance of any assessment claim | Manual | P1 | FR-117-AC-6, FR-117-AC-9 | ✅ passed |
| TC-1638 | A static admission completes from the static members of the FR-109 configuration document and the FR-110 inventory declaration alone, reaching no FR-108 population obligation, with the configuration's static prerequisite closure and the FR-116 native definition closure kept distinct members carrying distinct refusals | Integration | P0 | FR-117-AC-8, FR-117-CON-4, FR-117-CON-5 | ✅ passed |
| TC-1639 | Two bundles carrying one bundle identity and one namespaced revision with different canonical digest selections refuse as an identity collision naming both, re-admitting one bundle identity over different bytes yields a different admitted-bundle key with a prior binding refused as stale rather than resolved forward, and the bundle header identity, revision, and digest stay distinct from the model's and the profile's | Integration | P0 | FR-117-AC-10, FR-117-AC-11, FR-117-CON-6, FR-117-CON-7 | ✅ passed |
| TC-1640 | The JSON numbers `1`, `1.0`, and `1e0` canonicalize to the single byte string `1` and agree on one `filament-canonical-json-1` digest | Unit | P0 | FR-118-AC-1 | ✅ passed |
| TC-1641 | The adjacent integers `9007199254740992` and `9007199254740993` canonicalize to different byte strings and therefore to different digests | Unit | P0 | FR-118-AC-2 | ✅ passed |
| TC-1642 | A decimal carrying more significant digits than binary64 represents exactly round-trips to the same arbitrary-precision coefficient and exponent, and no numeric value is represented as a binary floating-point value at any point between parsing and serialization | Property | P0 | FR-118-AC-3, FR-118-CON-1 | ✅ passed |
| TC-1643 | An object whose keys differ in locale collation order and in encoded byte length from their Unicode scalar-value order canonicalizes in Unicode scalar-value order, sorted by the canonicalizer itself rather than by a map implementation's iteration order | Unit | P0 | FR-118-AC-4, FR-118-CON-2, FR-118-CON-5 | ✅ passed |
| TC-1644 | A string containing a quote, a backslash, U+0000, and U+001F canonicalizes with the quote and backslash escaped and each control character as a lowercase `\u00xx` escape, while a document carrying a string that is not valid Unicode refuses with a blocking refusal and digests nothing | Unit | P0 | FR-118-AC-5, FR-118-AC-6 | ✅ passed |
...
| TC-1600, TC-1601 | digest class | `filament-canonical-json-1` version `1` or `quire-native-bytes-1` version `1` | canonical-object or native raw-byte digest | Each domain is accepted only for its own input; the other direction refuses rather than revalidating |
| TC-1606, TC-1607 | revision class | `filament-core-data/producer-object-revision-1` or `quire-native/definition-revision-1` | producer object or native definition revision | Each namespace admits only its own object class; substitution refuses |
| TC-1615 | inventory completeness | closed or explicitly incomplete | component admission | Closed refuses the outsider; explicitly incomplete admits it carrying FR-110's retained `unknown` |
| TC-1640 | decimal form | `1`, `1.0`, or `1e0` | Filament Canonical JSON 1 | One canonical byte string and one digest for all three |
| TC-1645 | array disposition | set membership or semantic order | canonical digest | Permuting a set array changes no digest; permuting a semantic-order array changes it |
| TC-1673, TC-1674 | clock family | `event-position`, `fixed-sample`, or `timestamp` | window coverage form | Each family pairs only with its own half-open coverage form; a mismatched form refuses |
| TC-1668, TC-1669 | population world | closed with `declaredObjectUniverse` or open | membership admission | Closed refuses an outside object identity; an absent universe member refuses rather than defaulting to open |
| TC-1687, TC-1688 | v1.1 projection | lossless or lossy | baseline projection | Lossless projects as a new document; lossy refuses with a blocking loss record naming every lost member |
...
| FR-112-CON-3 | Allowed | A digest selection whose `version` is authored separately from its `domain` and selected by the configuration document | TC-1600, TC-1603 | Admitted |
| FR-112-CON-3 | Prohibited | A digest selection with no `version` member, the version to be read from the domain spelling | TC-1603 | Refuses |
| FR-112-CON-1 | Prohibited | A bare hash string offered as a binding digest | TC-1603 | Refuses and binds nothing |
| FR-113-CON-1 | Allowed | Exactly the two declared revision namespaces | TC-1606 | Admitted |
| FR-113-CON-1 | Prohibited | A third revision namespace, or a declared namespace the configuration does not select | TC-1609 | Refuses |
| FR-114-CON-4 | Allowed | A component locus naming the authored formal document revision | TC-1616 | Admitted |
| FR-114-CON-4 | Prohibited | A locus substituting a native source label for the formal document revision | TC-1614 | Refuses naming the offending record |
| FR-117-CON-1 | Allowed | Exactly the declared static content member classes | TC-1631, TC-1632 | Admitted |
| FR-117-CON-1 | Prohibited | Any assessment member class inside the static bundle | TC-1634 | Refuses naming the offered assessment member |
| FR-118-CON-7 | Allowed | A number at the configuration document's declared `maximumCoefficientDigits` and `maximumExponentMagnitude` | TC-1646 | Canonicalizes |
| FR-118-CON-7 | Prohibited | One digit or one exponent magnitude past the declared limit, or a configuration document declaring no `numericResourceLimit` | TC-1646 | Refuses before canonicalization with no rounded and no binary64 value, and applies no host limit |
| FR-119-CON-7 | Allowed | An assessment document at each declared `resourceLimits` bound | TC-1661, TC-1696 | Admitted |
| FR-119-CON-7 | Prohibited | One byte, one nesting level, or one member past a declared bound | TC-1661, TC-1696 | Refuses naming the exceeded bound and its declared value |
| FR-121-CON-6 | Allowed | A closed-world population carrying `declaredObjectUniverse` on the document | TC-1668 | Admitted |
| FR-121-CON-6 | Prohibited | A closed-world population with no `declaredObjectUniverse` member | TC-1669 | Refuses; never admitted as an open-world population |
| FR-122-CON-2 | Allowed | Half-open coverage with an inclusive start and an exclusive end in every declared clock family | TC-1674 | Admitted |
| FR-122-CON-2 | Prohibited | A closed or exclusive-start coverage form in any clock family | TC-1674 | Refuses |
| FR-122-CON-3 | Allowed | A `fixed-sample` `period` of `numerator` `1` over `denominator` `3` as arbitrary-precision base-10 integers | TC-1677 | Admitted and digested exactly, with no decimal expansion |
| FR-122-CON-3 | Prohibited | A `period` denominator of zero or a negative denominator, or a binary floating-point period | TC-1675 | Refuses naming that period |
| FR-126-CON-4 | Allowed | One interface version across exactly the documents one correspondence closure names | TC-1691 | Admitted |
| FR-126-CON-4 | Prohibited | Two interface versions inside one document set | TC-1694 | Refuses naming both versions and their documents; no agreeing subset admitted |
...
| complete static selection | indivisible static admission runs | admitted static bundle keyed by identity, namespaced revision and canonical digest selection | TC-1631, TC-1639 |
| admitted static bundle | one bundle identity is re-admitted over different bytes | a second admitted bundle under a different key; a binding naming the earlier bundle refuses as stale | TC-1639 |
| admitted static bundle | an assessment document names it by identity and admitted canonical digest selection | bound assessment document resolving its identities from that bundle's exports | TC-1663, TC-1664 |
| admitted static bundle | the named bundle's canonical digest selection has since changed | stale-selection refusal, never rebound to the current bundle | TC-1665 |
| bound assessment document | the static selection changes | a new assessment document; no existing assessment document is edited | TC-1666 |
| admitted static bundle | no population, snapshot or window exists at all | static link admitted with no observation requested | TC-1638, TC-1667 |
| 1.2 document with lossless authored presence | projection to v1.1 requested | a new v1.1 document with its own identity, revision and digest selection | TC-1687 |
| 1.2 document whose authored presence differs from the v1.1 derivation | projection to v1.1 requested | blocking loss record naming the field; no projection document | TC-1688 |
...
| ERR-290 | A canonical-object digest is offered under `quire-native-bytes-1`, or a native raw-byte digest under `filament-canonical-json-1` | Blocking refusal naming the selection; not revalidated in the other domain and not a cache miss | TC-1601 |
| ERR-291 | A digest selection's recomputed value differs from its declared value | Blocking refusal; not a warning and not a refetch invitation | TC-1602 |
| ERR-292 | A digest selection has an absent `version`, a domain or version outside the closed vocabulary, an admissible pair the configuration does not select, or is a bare hash string | Refusal that binds nothing | TC-1603 |
| ERR-293 | A revision is offered under the other declared namespace | Refusal | TC-1607 |
| ERR-294 | A bare revision string is offered as a binding revision, or a namespace lies outside the closed vocabulary or is undeclared by the configuration | Refusal that binds nothing | TC-1608, TC-1609 |
| ERR-295 | A component locus is absent, or an endpoint locus names no formal document revision | Blocking refusal naming the offending record | TC-1614 |
| ERR-296 | A component lies outside a closed declared inventory | Refusal of admission | TC-1615 |
| ERR-297 | A component's locus is supplied by no declaration source document | Blocking refusal naming the component; no synthesized locus emitted | TC-1616 |
| ERR-298 | A relationship endpoint omits its role or its multiplicity, or an endpoint projection collapses the two roles into one | Refusal with a named loss record carrying the relationship identity | TC-1620 |
| ERR-299 | A relationship endpoint's `endpointIdentity` names no declared endpoint | Blocking refusal naming the relationship | TC-1621 |
| ERR-300 | A correspondence export mapping names an export its producer object does not export, or one owned by another correspondence's producer object | Refusal | TC-1624 |
| ERR-301 | The producer-object or native-artifact selection changes while the prior binding relation is retained | Refusal; a re-encoding needs a new native artifact selection and a new record | TC-1625, TC-1626 |
| ERR-302 | A correspondence record omits the configuration provenance that authorized its relation, or its native definition-closure identities are incomplete | Refusal | TC-1627 |
| ERR-303 | Two correspondence records name one selected producer-object and native-artifact pair | Refusal | TC-1628 |
| ERR-304 | A static bundle omits a required header or content member | Refusal naming the absent member | TC-1633 |
| ERR-305 | An assessment member, an assessment-side export kind, or an assessment document is offered where a static admission is expected | Refusal naming the offered member, export or document; nothing silently retained | TC-1634 |
| ERR-306 | Two bundles carry one identity and revision with different canonical digest selections, or a binding names a superseded admitted bundle | Identity-collision or stale refusal naming both canonical digest selections | TC-1639 |
| ERR-307 | A canonical document carries a string that is not valid Unicode, a number past a declared numeric limit, or no `numericResourceLimit` member at all | Blocking refusal that digests nothing and substitutes no rounded, binary64 or host-chosen value | TC-1644, TC-1646 |
| ERR-308 | An assessment document carries no digest selection, no revision, or no configuration selection member | Refusal naming the absent member | TC-1659 |
| ERR-309 | Two assessment documents share one identity under one revision | Identity-collision refusal; the two are not merged | TC-1659 |
| ERR-310 | An assessment document exceeds a document-level bound declared in the authorizing configuration's `resourceLimits` | Refusal naming the exceeded bound and its declared value | TC-1661, TC-1696 |
| ERR-311 | An assessment document names a static bundle whose canonical digest selection differs from the admitted bundle's | Stale-static-selection refusal; never rebound to the current bundle | TC-1665 |
| ERR-312 | An assessment document names a static bundle that was never admitted | Refusal naming the unadmitted bundle | TC-1665 |
| ERR-313 | An assessment document names an identity absent from the bound bundle's export records, or an object or type identity absent from its selected model's exported type identities | Refusal naming that identity and the vocabulary it was resolved against | TC-1665 |
| ERR-314 | A bound assessment document and static bundle carry different configuration selections | Refusal naming both configuration selections | TC-1666 |
| ERR-315 | An assessment document carries a correspondence export whose kind is on the static side of FR-120's partition | Refusal naming that export kind | TC-1667, TC-1685 |
| ERR-316 | A closed-world population member lies outside `declaredObjectUniverse`, or a closed-world document carries no such member | Blocking refusal; never admitted as an open-world population | TC-1669 |
| ERR-317 | A population member's `typeIdentity` names a type the bound bundle's selected model does not export | Blocking refusal naming the type identity and the exported type vocabulary | TC-1669 |
| ERR-318 | A field-member state collapses absence, explicit null, or a present value into another of the three | Blocking refusal naming that field member | TC-1670 |
| ERR-319 | A relationship instance names an endpoint identity the population document does not declare | Blocking refusal naming the dangling endpoint identity | TC-1670 |
| ERR-320 | A window declares a coverage form belonging to another clock family | Blocking refusal naming the incompatible coverage form | TC-1675 |
| ERR-321 | A window selects from two populations, or from a population and a snapshot at once | Refusal naming the competing selection sources | TC-1675 |
| ERR-322 | A `fixed-sample` `period` is a binary floating-point value, or carries a zero or negative denominator | Blocking refusal naming that period | TC-1675 |
| ERR-323 | A window carries two observation records under one record identity or one ordering position | Refusal naming the collision | TC-1676 |
| ERR-324 | An availability fact carries no `availabilityFactIdentity`, no observation-record identity, or names an observation record the bound documents do not contain | Refusal naming the absent or unknown member | TC-1680 |
| ERR-325 | An unavailable observation is represented as a member omitted from population, snapshot or window membership, or two facts of one document name one observation record | Refusal naming the omitted member or both facts; no merged fact emitted | TC-1680 |
| ERR-326 | A document the producer would emit carries a member holding a truth disposition | Refusal naming that member | TC-1680 |
| ERR-327 | A projection's source carries an authored presence differing from the v1.1 derivation, or a 1.2-only member for which v1.1 declares no counterpart | Blocking loss record naming every lost member individually; no projection document | TC-1688 |
| ERR-328 | A projection passes only because a member of its source model, population or document was rewritten | Blocking refusal naming the rewritten member; the source is emitted unchanged | TC-1689 |
| ERR-329 | A document declares an interface version the producer does not implement, or carries no `interfaceVersion` or no `wireSchema` member | Refusal naming the version or the absent member; no best-effort read and no nearest-known version | TC-1691, TC-1693 |
...
| EC-170 | A repository, a component, a role and an endpoint that share one display name | FR-114 | TC-1613 | Four identities collapse into one and a binding resolves against an object nobody selected |
| EC-171 | A self-relationship whose `source` and `target` name one type identity | FR-115 | TC-1619 | One endpoint is reconstructed from the other and its own role and multiplicity are lost |
| EC-172 | One revision `value` spelling under both declared namespaces | FR-113 | TC-1610 | Two distinct revisions merge and a native definition is read as a producer object |
| EC-173 | A producer canonical digest and a native raw-byte digest whose hash text coincides | FR-116, FR-124 | TC-1630, TC-1685 | A cross-domain substitution passes as a cache hit instead of refusing |
| EC-174 | A presentation-only native re-encoding of an already-bound native artifact | FR-116 | TC-1626 | The digest is substituted under the retained binding relation instead of a new correspondence record |
| EC-175 | A component admitted under an explicitly incomplete inventory | FR-110, FR-114 | TC-1615 | The retained `unknown` disposition is resolved to closed, so the component is wrongly refused or silently admitted |
| EC-176 | `1`, `1.0` and `1e0` written for one declared value | FR-118 | TC-1640 | Three canonical byte strings and three digests stand for one value |
| EC-177 | The adjacent integers `9007199254740992` and `9007199254740993` | FR-118 | TC-1641 | A binary64 round trip merges the two and one digest covers both |
| EC-178 | A decimal carrying more significant digits than binary64 represents exactly | FR-118 | TC-1642 | A digit is rounded and the canonical bytes become a property of the host |
| EC-179 | An insertion-order-preserving map, and the consumer's wire member order on the same document | FR-118, NFR-036 | TC-1647, TC-1651 | The walk order reaches the bytes and a transmission order becomes a digest input |
| EC-180 | One bundle identity re-admitted over different bytes | FR-117 | TC-1639 | A prior binding follows the identity forward and the result describes a subject nobody chose |
| EC-181 | A static admission attempted with no population, snapshot or window in existence | FR-117, FR-120 | TC-1638, TC-1667 | An observation becomes a prerequisite of recognition, so static linking requires minting inputs no one observed |
| EC-182 | Two observations of one member object | FR-121, FR-122 | TC-1670, TC-1676 | The two records merge and one ordering position stands for both |
| EC-183 | Two availability facts naming one observation record | FR-123 | TC-1680 | The facts merge and one reason is lost |
| EC-184 | A `fixed-sample` `period` of one third | FR-122 | TC-1677 | A decimal expansion is emitted and digested and the period stops being exact |
| EC-185 | An observation the producer could not obtain, outside the evaluator's declared admitted support | FR-123 | TC-1679 | The producer asserts a truth disposition instead of declaring an availability fact |
| EC-186 | A window supplied against the `clock` binding kind because no consumer export or artifact kind carries a window | FR-119, FR-124 | TC-1662, TC-1684 | A window is minted under an invented kind, or the selection is dropped |
| EC-187 | A population document named by identity and canonical digest because no consumer artifact kind admits one | FR-119, FR-124 | TC-1662, TC-1684 | A population document is given an artifact kind the pinned consumer contract does not carry |
| EC-188 | A v1.1 projection emitted beside the 1.2 document it was projected from | FR-125, FR-126 | TC-1690, TC-1695 | The pair reads as one two-version document set and refuses, or `v1.1` is written as a model revision value |
| EC-189 | Two interface versions differing only in their patch component | FR-126 | TC-1692 | A patch increment changes an admission or a refusal and the classification stops being a contract |
| EC-190 | An assessment document one byte, one nesting level and one member past each declared bound | NFR-037 | TC-1696, TC-1698 | A bound is enforced from a crate constant and two hosts disagree on which documents exist at all |
...
TC-1600..1499 are open: none is bound to a test, none has been measured, and the
shipped `crates/baseline-producer` contradicts the design in every respect
SR-213 recorded as Plan-017 work. The static half TC-1600..1456 is the increment
under implementation and its rows flip only as Plan-017 lands them; the
assessment half TC-1657..1499 is deliberately unimplemented here and stays
...
carries a `window` member — which TC-1662, TC-1684, EC-186 and EC-187 record as
...
TC-1600..1499 add no passing result to the line above: every one of them is
`🚧 planned` and none is bound to a test. TC-1600..1456 are the static half being
implemented now, and TC-1657..1499 are the assessment half this increment does
