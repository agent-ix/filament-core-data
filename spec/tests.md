...
| TC-1252 | slug("Config Version") is Config-Version, slug("A__B--C") is A-B-C, slug("versionNumber") is versionNumber, slug("--") and slug("_") are Unsluggable (no part is dropped), and an enumeration value reading _ raises UNSLUGGABLE_NAME at its locus, blocking; a "---" title fails earlier as UNNAMEABLE_ARTIFACT | Unit | P1 | FR-095-AC-7 | ✅ passed |
