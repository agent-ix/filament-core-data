...
| US-016 | US-016-EX-1 (illustrative) implemented by FR-117 and FR-120 | TC-1431, TC-1438, TC-1467 | ✅ Complete |
| US-016 | US-016-EX-2 (illustrative) implemented by FR-112 | TC-1401, TC-1402 | ✅ Complete |
| US-016 | US-016-EX-3 (illustrative) implemented by FR-113 | TC-1407, TC-1408 | ✅ Complete |
| US-016 | US-016-EX-4 (illustrative) implemented by FR-114 and FR-115 | TC-1412, TC-1418, TC-1420 | ✅ Complete |
| US-016 | Static producer boundary implemented by FR-112..FR-118 and NFR-036 | TC-1400..TC-1456 | ✅ Complete — TC-1448 and TC-1452 measured on x86_64-unknown-linux-gnu only |
...
| FR-112 | FR-112-AC-1..7, FR-112-CON-1..5 | TC-1400..TC-1405 | ✅ Complete |
| FR-113 | FR-113-AC-1..6, FR-113-CON-1..5 | TC-1406..TC-1410 | ✅ Complete |
| FR-114 | FR-114-AC-1..5, FR-114-CON-1..6 | TC-1411..TC-1416 | ✅ Complete |
| FR-115 | FR-115-AC-1..5, FR-115-CON-1..5 | TC-1417..TC-1422 | ✅ Complete |
| FR-116 | FR-116-AC-1..9, FR-116-CON-1..5 | TC-1423..TC-1430 | ✅ Complete |
| FR-117 | FR-117-AC-1..11, FR-117-CON-1..7 | TC-1431..TC-1439 | ✅ Complete |
| FR-118 | FR-118-AC-1..12, FR-118-CON-1..7 | TC-1440..TC-1449 | ✅ Complete |
...
| FR-127 | FR-127-AC-1..12, FR-127-CON-1..9 | TC-1500..TC-1512 | ✅ Complete |
| FR-128 | FR-128-AC-1..9, FR-128-CON-1..6 | TC-1513..TC-1521 | ✅ Complete |
| FR-129 | FR-129-AC-1..12, FR-129-CON-1..7 | TC-1522..TC-1529 | ✅ Complete |
...
| TC-1401 | A canonical-object digest offered under `quire-native-bytes-1` and a native raw-byte digest offered under `filament-canonical-json-1` each refuse, rather than being revalidated in the other domain | Unit | P0 | FR-112-AC-2 | ✅ passed |
| TC-1402 | A digest selection whose recomputed value differs from its declared value refuses with a blocking refusal, not a warning, a cache miss, or a refetch invitation | Unit | P0 | FR-112-AC-3 | ✅ passed |
...
| TC-1404 | A source-provenance locus carrying the consumer-owned `ArtifactRef.digest` raw-byte string and the consumer-owned `NativeSource.revision` authority label is admitted, and neither member refuses as a malformed digest selection | Unit | P1 | FR-112-AC-6, FR-112-CON-4 | ✅ passed |
| TC-1405 | One producer object transmitted under two different wire member orders yields one identical digest `value`, because every canonical-object digest input is the FR-118 canonicalizer output for that object rather than the producer's own serializer | Property | P0 | FR-112-AC-7, FR-112-CON-2 | ✅ passed |
...
| TC-1407 | A native definition revision offered under the producer-object namespace and a producer-object revision offered under the native definition namespace each refuse | Unit | P0 | FR-113-AC-2 | ✅ passed |
| TC-1408 | A bare revision string offered in place of a two-member revision the producer authors refuses and binds nothing | Unit | P0 | FR-113-AC-3, FR-113-CON-2 | ✅ passed |
| TC-1409 | A revision namespace outside the closed admissible vocabulary refuses, and one inside it that the configuration document does not declare as a selection refuses | Unit | P0 | FR-113-AC-4, FR-113-CON-5 | ✅ passed |
| TC-1410 | Two revisions sharing one `value` spelling under the two declared namespaces remain two distinct revisions, and a locus carrying the consumer-owned `NativeSource.revision` label and `ArtifactRef.digest` string is admitted rather than refused as a malformed revision | Unit | P1 | FR-113-AC-5, FR-113-AC-6, FR-113-CON-3, FR-113-CON-4 | ✅ passed |
| TC-1411 | One component record carries its identity, namespaced revision, canonical digest selection, locus, ownership, and inventory membership as six separate members that equal spelling never merges | Unit | P0 | FR-114-AC-1, FR-114-CON-3 | ✅ passed |
| TC-1412 | One endpoint record carries the same six members and additionally names its owning component identity, its type identity, its role, and its multiplicity, none reconstructed from another | Unit | P0 | FR-114-AC-1 | ✅ passed |
| TC-1413 | A repository, a component, a role, and an endpoint sharing one display name remain four distinct identities, and no component identity is reconstructed from a path, a package name, or a deployment name | Unit | P0 | FR-114-AC-1, FR-114-CON-1, FR-114-CON-2 | ✅ passed |
| TC-1414 | A component whose locus is absent refuses, and an endpoint whose locus names no formal document revision refuses, each with a blocking refusal naming the offending record and neither substituting a native source label for the formal revision | Unit | P0 | FR-114-AC-2, FR-114-CON-4 | ✅ passed |
| TC-1415 | A component outside a closed declared inventory refuses admission, while the same component under an explicitly incomplete inventory is admitted carrying the completeness member with the retained `unknown` disposition FR-110 owns | Integration | P0 | FR-114-AC-3, FR-114-CON-6 | ✅ passed |
| TC-1416 | A full locus carrying `source` with `refVersion`, `kind`, `authority`, `identity`, a namespaced revision, one raw-byte digest string and `wire`, plus `formal` and `span`, is admitted with its raw-byte digest string, while a component whose locus no declaration source document supplies refuses and no synthesized locus is emitted | Unit | P0 | FR-114-AC-4, FR-114-AC-5, FR-114-CON-5 | ✅ passed |
| TC-1417 | One relationship record carries its identity, namespaced revision, canonical digest, authored name, `semantics` category with direction, composite flag, lifecycle and ownership, and the owning model, profile, and configuration identities as separate members | Unit | P0 | FR-115-AC-1, FR-115-CON-4 | ✅ passed |
| TC-1418 | The `source` and `target` endpoint records of one relationship each carry their own `endpointIdentity`, `typeIdentity`, `role`, and `multiplicity` as independent members even when both name one type identity | Unit | P0 | FR-115-AC-1, FR-115-CON-3 | ✅ passed |
| TC-1419 | A self-relationship whose `source` and `target` name one type identity emits two independent endpoint records retaining their own endpoint identities, roles, and multiplicities | Unit | P0 | FR-115-AC-2 | ✅ passed |
| TC-1420 | A relationship whose `source` omits its role refuses, one whose `target` omits its multiplicity refuses, and an endpoint projection collapsing the two roles into one refuses with a named loss record carrying the relationship identity rather than a guessed value | Unit | P0 | FR-115-AC-3 | ✅ passed |
| TC-1421 | Each `source` and `target` endpoint record joins a declared FR-114 endpoint through its `endpointIdentity` and never through a coinciding type identity, role, or display name, and a `source` `endpointIdentity` naming no declared endpoint refuses naming the relationship | Integration | P0 | FR-115-AC-4, FR-115-AC-5, FR-115-CON-5 | ✅ passed |
| TC-1422 | A relationship identity is authored rather than reconstructed from a foreign key, a field, or a relationship instance, and the emitted record carries no population member and no relationship instance | Unit | P0 | FR-115-CON-1, FR-115-CON-2 | ✅ passed |
...
| TC-1424 | A correspondence record whose export mapping names an export its producer object does not export refuses, and one naming an export owned by another correspondence's producer object refuses | Unit | P0 | FR-116-AC-2 | ✅ passed |
| TC-1425 | Changing the producer object selection or the native artifact selection while retaining the prior binding relation refuses | Unit | P0 | FR-116-AC-3 | ✅ passed |
| TC-1426 | A presentation-only native re-encoding is admitted only through a new native artifact selection and a new correspondence record, never through a digest substitution under the retained relation | Unit | P0 | FR-116-AC-3 | ✅ passed |
| TC-1427 | A correspondence record submitted without the configuration provenance that authorized its relation refuses, and one whose required native definition-closure identities are incomplete refuses | Unit | P0 | FR-116-AC-4, FR-116-AC-5 | ✅ passed |
| TC-1428 | Two correspondence records naming one selected pair refuse, and a producer object the consumer does not select yields no correspondence record | Unit | P0 | FR-116-AC-6, FR-116-AC-7, FR-116-CON-4 | ✅ passed |
| TC-1429 | Every emitted export mapping carries its exporting producer object identity, its `exportKind` from the consumer's closed vocabulary, its ordered `exportPath` segments, and its formal export locus, the record carries no consumer table index and no producer-object interface index, and no export kind FR-120 partitions to the assessment side is emitted | Unit | P0 | FR-116-AC-8, FR-116-AC-9, FR-116-CON-2 | ✅ passed |
| TC-1430 | A producer canonical digest selection and a native raw-byte digest selection stay distinct members when their hash text coincides, and every consumer `u32` table index including the producer-object interface index is left unassigned | Static | P1 | FR-116-CON-3, FR-116-CON-5 | ✅ passed |
| TC-1431 | A complete static selection is admitted as one immutable typed bundle whose bundle identity, namespaced revision, canonical digest selection, producer interface version, model, profile, component and endpoint declarations, relationship records, inventory declaration, configuration document, static prerequisite closure, and correspondence records are each read directly as typed members | Unit | P0 | FR-117-AC-1 | ✅ passed |
| TC-1432 | The admitted static bundle carries no population, snapshot, window, instance, observation, progress record, or observation closure, and the bundle type is closed over exactly the declared content member classes and that exclusion and over no header member | Compile | P0 | FR-117-AC-1, FR-117-CON-1 | ✅ passed |
| TC-1433 | A bundle omitting any required member, whether a header member, an identity, a namespaced revision, a digest selection, a provenance locus, an ownership member, an inventory membership, or the static prerequisite closure, is refused and the refusal names the absent member | Unit | P0 | FR-117-AC-2 | ✅ passed |
| TC-1434 | An assessment member offered inside the static bundle refuses naming that member, an assessment document offered in place of a static admission refuses naming that document, and a correspondence export of the assessment kind FR-120 partitions to the assessment side refuses naming that export | Unit | P0 | FR-117-AC-3, FR-117-AC-7 | ✅ passed |
| TC-1435 | The static bundle type exposes no public constructor, no public member, and no deserialization path that bypasses admission, so no unvalidated value of the type can be constructed and a refused admission yields no value | Compile | P0 | FR-117-AC-4, FR-117-CON-2 | ✅ passed |
| TC-1436 | A static admission run with altered environment variables, an altered working directory, an altered wall clock, and no network reachability produces the identical admitted bundle | Integration | P0 | FR-117-AC-5, FR-117-CON-3 | ✅ passed |
| TC-1437 | Every member of an admitted static bundle is read without parsing prose, defaulting a member, or inferring a field, and production of the bundle is recorded as static admission only rather than as campaign acceptance of any assessment claim | Manual | P1 | FR-117-AC-6, FR-117-AC-9 | ✅ passed |
| TC-1438 | A static admission completes from the static members of the FR-109 configuration document and the FR-110 inventory declaration alone, reaching no FR-108 population obligation, with the configuration's static prerequisite closure and the FR-116 native definition closure kept distinct members carrying distinct refusals | Integration | P0 | FR-117-AC-8, FR-117-CON-4, FR-117-CON-5 | ✅ passed |
| TC-1439 | Two bundles carrying one bundle identity and one namespaced revision with different canonical digest selections refuse as an identity collision naming both, re-admitting one bundle identity over different bytes yields a different admitted-bundle key with a prior binding refused as stale rather than resolved forward, and the bundle header identity, revision, and digest stay distinct from the model's and the profile's | Integration | P0 | FR-117-AC-10, FR-117-AC-11, FR-117-CON-6, FR-117-CON-7 | ✅ passed |
| TC-1440 | The JSON numbers `1`, `1.0`, and `1e0` canonicalize to the single byte string `1` and agree on one `filament-canonical-json-1` digest | Unit | P0 | FR-118-AC-1 | ✅ passed |
| TC-1441 | The adjacent integers `9007199254740992` and `9007199254740993` canonicalize to different byte strings and therefore to different digests | Unit | P0 | FR-118-AC-2 | ✅ passed |
...
| TC-1448 | One configuration document's declared `numericResourceLimit` refuses the same numbers and admits the same numbers on each architecture of the set NFR-036 names, so no admit-versus-refuse decision differs by host | Integration | P0 | FR-118-AC-11 | 🚧 x86_64-unknown-linux-gnu measured; cross-architecture agreement unrun — aarch64-unknown-linux-gnu is unreachable on this host (no cross linker, no qemu runner) and `make baseline-producer-cross-architecture` reds naming it rather than skipping |
| TC-1449 | An object's own digest member is excluded from the canonical bytes that object digests, and this exclusion is applied only here rather than restated by a digest consumer | Unit | P0 | FR-118-CON-4 | ✅ passed |
| TC-1450 | Every digested document of one admitted static bundle canonicalizes to the same byte string and digest across two runs in one process and two runs in two separate processes, and to the committed golden byte string | Snapshot | P0 | NFR-036 | ✅ passed |
| TC-1451 | Every digested document's digest is unchanged when its object keys and set-array members are supplied in a permuted insertion order, over the declared permutation set, one paired run per permutation | Property | P0 | NFR-036 | ✅ passed |
...
| TC-1453 | Every digested document's canonical byte string agrees across a changed locale, environment, and working directory against the same committed golden | Snapshot | P0 | NFR-036 | ✅ passed |
| TC-1454 | The declared numeric-path population reaches zero binary floating-point coercion sites between parsing and serialization, and the audit fails on a scratch copy carrying a planted float conversion | Static | P0 | NFR-036 | ✅ passed |
| TC-1455 | Every semantic-order array is emitted in the producer-declared order, measured per array against that declaration, with a permuted-array paired run whose digest must differ | Property | P0 | NFR-036 | ✅ passed |
| TC-1456 | Canonicalizing an admitted static bundle reads zero locales, environment variables, working directories, clocks, and sockets with no exemption, measured by call-graph analysis and by an instrumented offline run in an unprivileged network namespace | Static | P0 | NFR-036 | ✅ static evidence (make baseline-producer-ambient-evidence) |
...
|---|---|---|---|---|---|
| Static | 274 | 236 | 0 | 38 | 100% mapped (274/274) |
| Manual | 50 | 46 | 0 | 4 | 100% mapped (50/50) |
| Analysis | 47 | 29 | 0 | 18 | 100% mapped (47/47) |
| Property | 134 | 76 | 0 | 58 | 100% mapped (134/134) |
| Unit | 559 | 429 | 0 | 130 | 100% mapped (559/559) |
| Integration | 137 | 86 | 0 | 51 | 100% mapped (137/137) |
| Fuzz | 14 | 8 | 0 | 6 | 100% mapped (14/14) |
| Snapshot | 70 | 36 | 0 | 34 | 100% mapped (70/70) |
| Compile | 22 | 7 | 0 | 15 | 100% mapped (22/22) |
| E2E | 12 | 12 | 0 | 0 | 100% mapped (12/12) |
| Benchmark | 1 | 0 | 0 | 1 | 100% mapped (1/1) |
| **Total** | **1320** | **965** | **0** | **355** | **100% mapped (1320/1320)** |
