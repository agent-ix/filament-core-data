...
than deciding it.
Issue #36 (the spec-bundle extraction frontend, TC-1200..1350) is mapped
...
blocked on issue #85. Nine rows are `Static` evidence produced by
...
The Producer interface 1.2.0 design pass then allocated TC-1400..1499, reserved
and confirmed unused on every remote branch before the pass began. The block is
split so the two halves are legible at a glance. TC-1400..1456 carry the static
half — US-016, FR-112..FR-118 and NFR-036 — which is being implemented now and
whose rows are therefore planned, not passing: no producer, canonicalizer,
bundle admission or gate apparatus exists yet, and Plan-017 owns the golden
bytes, the second architecture, the planted-token controls and the offline
namespace that four of the NFR-036 rows depend on. TC-1457..1499 carry the
assessment half — US-017, FR-119..FR-126 and NFR-037 — which SR-213 reviewed as
one design with the static half but which this increment does not implement, so
those rows are marked planned and out of this increment's implementation scope.
Both halves are bound against SR-208's and SR-213's `## Coverage rules`: the
compound criteria those reviews name — FR-114-AC-1, FR-115-AC-1, FR-116-AC-3,
FR-117-AC-1 and the compound criteria of FR-119, FR-122 and FR-124 — each bind
more than one row, and the eight one-axis adverse axes are eight distinct rows
that no row combines: TC-1433 missing identities, TC-1401 and TC-1402 digest
domain substitution and digest mismatch, TC-1407 revision namespace
substitution, TC-1424 foreign or cross-bound exports, TC-1420 endpoint role and
multiplicity loss, TC-1414 absent component and endpoint provenance, TC-1425
changed selection under a retained correspondence, and TC-1415 incomplete
inventory. NFR-036 and NFR-037 declare metrics rather than acceptance criteria,
so their rows trace the requirement id itself, as the NFR-004..NFR-012 rows
already do; NFR-036's seven metrics are seven rows and NFR-037's ten metrics are
grouped into four by measurement apparatus. One row, TC-1462, absorbs six
criteria of three verification kinds because the reserved block is a hundred ids
over 242 criteria; its `Type` names what makes it fail, as the vocabulary note
above records.
...
|---|---|---|---|
| StR-001 | US-001..US-010, US-012, US-013, US-015..US-017, FR-001..FR-053, FR-063..FR-080, FR-091..FR-126 | TC-033, TC-086, TC-129, TC-130..644, TC-745..944, TC-1200..1350, TC-1373..1387, TC-1400..1499 | ⚠️ TC-370, TC-382 blocked on issue #42; TC-745..844 in progress on the issue #22 branch; TC-1373..1387 planned on #95; TC-1400..1456 planned on the #95 static half and TC-1457..1499 planned on the #95 assessment half, which this increment does not implement |
...
| US-016 | US-016-EX-1 (illustrative) implemented by FR-117 and FR-120 | TC-1431, TC-1438, TC-1467 | 🚧 planned — #95 static half, not yet implemented |
| US-016 | US-016-EX-2 (illustrative) implemented by FR-112 | TC-1401, TC-1402 | 🚧 planned — #95 static half, not yet implemented |
| US-016 | US-016-EX-3 (illustrative) implemented by FR-113 | TC-1407, TC-1408 | 🚧 planned — #95 static half, not yet implemented |
| US-016 | US-016-EX-4 (illustrative) implemented by FR-114 and FR-115 | TC-1412, TC-1418, TC-1420 | 🚧 planned — #95 static half, not yet implemented |
| US-016 | Static producer boundary implemented by FR-112..FR-118 and NFR-036 | TC-1400..TC-1456 | 🚧 planned — #95 static half, not yet implemented |
| US-017 | US-017-EX-1 (illustrative) implemented by FR-119 and FR-120 | TC-1457, TC-1463, TC-1465 | 🚧 planned — #95 assessment half, not in this increment |
| US-017 | US-017-EX-2 (illustrative) implemented by FR-120 | TC-1467 | 🚧 planned — #95 assessment half, not in this increment |
| US-017 | US-017-EX-3 (illustrative) implemented by FR-123 | TC-1479, TC-1481 | 🚧 planned — #95 assessment half, not in this increment |
| US-017 | US-017-EX-4 (illustrative) implemented by FR-126 | TC-1493 | 🚧 planned — #95 assessment half, not in this increment |
| US-017 | Assessment boundary implemented by FR-119..FR-126 and NFR-037 | TC-1457..TC-1499 | 🚧 planned — #95 assessment half, not in this increment |
...
| FR-095 | FR-095-AC-1..15, FR-095-CON-1..3 | TC-1246..TC-1258, TC-1347, TC-1348 | ✅ Complete |
...
| FR-106 | FR-106-AC-1..5, FR-106-CON-1..2 | TC-1373, TC-1374 | ✅ Complete |
| FR-107 | FR-107-AC-1..3, FR-107-CON-1..2 | TC-1375 | ✅ Complete |
| FR-108 | FR-108-AC-1..5, FR-108-CON-1..2 | TC-1376..TC-1378 | ✅ Complete |
| FR-109 | FR-109-AC-1..5, FR-109-CON-1..2 | TC-1379..TC-1381 | 🚧 TC-1380 remains Task-141 native static/assessment linking |
...
| FR-112 | FR-112-AC-1..7, FR-112-CON-1..5 | TC-1400..TC-1405 | 🚧 planned — #95 static half, not yet implemented |
| FR-113 | FR-113-AC-1..6, FR-113-CON-1..5 | TC-1406..TC-1410 | 🚧 planned — #95 static half, not yet implemented |
| FR-114 | FR-114-AC-1..5, FR-114-CON-1..6 | TC-1411..TC-1416 | 🚧 planned — #95 static half, not yet implemented |
| FR-115 | FR-115-AC-1..5, FR-115-CON-1..5 | TC-1417..TC-1422 | 🚧 planned — #95 static half, not yet implemented |
| FR-116 | FR-116-AC-1..9, FR-116-CON-1..5 | TC-1423..TC-1430 | 🚧 planned — #95 static half, not yet implemented |
| FR-117 | FR-117-AC-1..11, FR-117-CON-1..7 | TC-1431..TC-1439 | 🚧 planned — #95 static half, not yet implemented |
| FR-118 | FR-118-AC-1..12, FR-118-CON-1..7 | TC-1440..TC-1449 | 🚧 planned — #95 static half, not yet implemented |
| FR-119 | FR-119-AC-1..10, FR-119-CON-1..8 | TC-1457..TC-1462 | 🚧 planned — #95 assessment half, not in this increment |
| FR-120 | FR-120-AC-1..10, FR-120-CON-1..8 | TC-1463..TC-1467 | 🚧 planned — #95 assessment half, not in this increment |
| FR-121 | FR-121-AC-1..9, FR-121-CON-1..6 | TC-1468..TC-1471 | 🚧 planned — #95 assessment half, not in this increment |
| FR-122 | FR-122-AC-1..11, FR-122-CON-1..6 | TC-1472..TC-1477 | 🚧 planned — #95 assessment half, not in this increment |
| FR-123 | FR-123-AC-1..9, FR-123-CON-1..5 | TC-1478..TC-1481 | 🚧 planned — #95 assessment half, not in this increment |
...
| TC-1223 | versionNumber Integer 1 min: 1 emits one kind: alias type/ConfigVersion.versionNumber targeting type/Integer at the row, carrying one min constraint with operands.value 1, appliesTo the alias identity, and diagnosticCode agent-ix.<name>.VERSION_NUMBER_MIN; the field typeRef is the alias, the record constraints are [], and no unconstrained field mints an alias | Unit | P1 | FR-093-AC-4 | ✅ passed |
| TC-1224 | maxLength: 64 emits {value: 64} on the alias type/ConfigVersion.createdBy targeting type/String, a pattern /^[a-z]+$/ cell emits {regex, dialect: ecma-262}, an enumValues a or b cell emits {values: [a, b]}, and a two-keyword row yields one alias carrying both constraints | Unit | P1 | FR-093-AC-5 | ✅ passed |
...
| TC-1241 | The operations fixture lowers each OperationDecl with params as fields under param/<record-slug>-<op-slug>-<param-slug>, returns nullable false, pre and post as clauseId lists, and no second clause node | Unit | P1 | FR-094-AC-11 | ✅ passed |
...
| TC-1243 | Every relationship, operation, parameter, and clause identity on the fixture matches the FR-095 minting pattern, asserted by regex over every emitted node | Property | P1 | FR-094-AC-13 | ✅ passed |
...
| TC-1251 | Every identity in the emitted business fixture document matches exactly one pattern of the closed list, including param/ and variant/, and semanticIdentity, asserted by regex over every node | Property | P1 | FR-095-AC-6 | ✅ passed |
| TC-1252 | slug("Config Version") is config-version, slug("A__B--C") is a-b-c, slug("--") is Unsluggable, and an enumeration value reading *** raises UNSLUGGABLE_NAME at its locus, blocking; a "---" title fails earlier as UNNAMEABLE_ARTIFACT | Unit | P1 | FR-095-AC-7 | ✅ passed |
...
| TC-1259 | Every Code variant serialises to a code matching the published pattern and, instantiated with and without a locus, validates as a diagnostic against common.schema.json | Property | P1 | FR-096-AC-1 | ✅ passed |
| TC-1260 | The severity and blocking table holds variant by variant as a function of Code alone plus the engine severity and the ARTIFACT_NOT_LOWERED reason, including the five error-blocking codes and KERNEL_NAME_SHADOWED | Unit | P0 | FR-096-AC-2, FR-096-CON-1 | ✅ passed |
...
| TC-1267 | The negatives/DUPLICATE_TYPE_NAME fixture lifted twice produces diagnostic bytes identical to each other and to its committed expected/diagnostics.json | Snapshot | P1 | FR-096-AC-9, FR-096-CON-3 | ✅ passed |
...
| TC-1271 | extraction-frontend-diagnostics.md lists every code with severity, blocking, and owner, and regenerating it from the enum reproduces the committed file byte for byte | Snapshot | P1 | FR-096-AC-13 | ✅ passed |
| TC-1272 | The set of fixtures/negatives/<CODE>/ directories FR-098 lists equals the set of Code variants, so every registry code has one fixture or one named constructing test | Static | P1 | FR-096-AC-14 | ✅ passed |
...
| TC-1288 | Every FR-096 code is emitted by its negatives/<CODE>/ bundle or the test constructed.json names, at the golden's recorded line and column or with no locus, and no negatives bundle emits a second code | Snapshot | P1 | FR-098-AC-4 | ✅ passed |
...
| TC-1333 | The business enumeration artifact lowers to one kind: enum with one variant per ## Values row named verbatim at variant/<enum-slug>-<value-slug> with origin at the row line column 3; no ## Values emits blocking ARTIFACT_NOT_LOWERED; every kind: alias in a fixture document is a constrained field's alias named <DisplayName>.<fieldName>, targeting a non-alias, named by exactly that field's typeRef, carrying a constraint | Unit | P1 | FR-093-AC-12 | ✅ passed |
| TC-1334 | Documents titled Status and status raise DUPLICATE_TYPE_NAME at the second path naming both; a row reading min: 1, min: 2 and fields versionNumber and version_number each carrying min raise DUPLICATE_CONSTRAINT at the second row | Unit | P1 | FR-093-AC-13 | ✅ passed |
...
| TC-1343 | The set of directories under fixtures/, fixtures/negatives/, and fixtures/modules/ equals the FR-098 inventory, and every constructed.json names a test function that exists under crates/extraction-frontend/tests/ | Static | P1 | FR-098-AC-11 | ✅ passed |
...
| TC-1347 | Two records titled Status and status slug to the same status, and lifting a bundle holding both refuses at the second document with DUPLICATE_TYPE_NAME and mints no field/status-* identity twice; an artifact whose displayName is a kernel scalar the bundle uses is refused likewise (FR-093-AC-13 clause 4) | Unit | P1 | FR-095-AC-14, FR-093-AC-13 | ✅ passed |
...
| TC-1374 | A v1.2 field whose authored presence matches the historical v1.1 derivation projects without a presence loss | Unit | P1 | FR-106-AC-4 | ✅ passed |
| TC-1375 | Relationship declarations preserve distinct endpoint multiplicities and stable endpoints, reject a field-only invented relationship, retain endpoint-role loss, and refuse a composite cycle | Integration | P0 | FR-107-AC-1, FR-107-AC-2, FR-107-AC-3, FR-107-CON-1, FR-107-CON-2 | ✅ passed |
| TC-1376 | A closed population distinguishes absent/null/value, rejects an undeclared relationship endpoint, and rejects an object outside its declared universe | Integration | P0 | FR-108-AC-1, FR-108-AC-2, FR-108-CON-1 | ✅ passed |
| TC-1377 | An unavailable observation outside exact support leaves a decisive result plus explicit availability incomplete, while removing required support returns unavailable/incomplete and retains its observation-record identity | Integration | P0 | FR-108-AC-3, FR-108-CON-2 | ✅ passed |
| TC-1378 | Two records for one member remain ordered records, and event-position, fixed-sample, and timestamp windows preserve selected half-open coverage and reject family mismatch | Integration | P0 | FR-108-AC-4, FR-108-AC-5 | ✅ passed |
| TC-1379 | An unknown profile and a missing explicit configuration refuse before evaluation; changing only a resource limit changes retained configuration identity | Unit | P0 | FR-109-AC-1, FR-109-AC-2, FR-109-AC-3, FR-109-CON-1, FR-109-CON-2 | ✅ passed |
...
| TC-1381 | A producer canonical-object digest and a native raw-byte digest are accepted only in their named domains, and substitution refuses | Unit | P0 | FR-109-AC-5 | ✅ passed |
...
| TC-1400 | A canonical-object digest and a native raw-byte digest are each emitted as the four-member selection whose `algorithm`, `domain`, `version`, and `value` map member-for-member onto the pinned consumer `SelectedDigest`, with `version` a separate authored member never supplied by the domain spelling | Unit | P0 | FR-112-AC-1, FR-112-CON-3 | 🚧 planned — #95 static half, not yet implemented |
| TC-1401 | A canonical-object digest offered under `quire-native-bytes-1` and a native raw-byte digest offered under `filament-canonical-json-1` each refuse, rather than being revalidated in the other domain | Unit | P0 | FR-112-AC-2 | 🚧 planned — #95 static half, not yet implemented |
| TC-1402 | A digest selection whose recomputed value differs from its declared value refuses with a blocking refusal, not a warning, a cache miss, or a refetch invitation | Unit | P0 | FR-112-AC-3 | 🚧 planned — #95 static half, not yet implemented |
| TC-1403 | A digest selection with an absent `version`, one whose domain or version lies outside the closed admissible vocabulary, one whose admissible pair the configuration document does not select, and a bare hash string offered in place of a selection each refuse and bind nothing | Unit | P0 | FR-112-AC-4, FR-112-AC-5, FR-112-CON-1, FR-112-CON-5 | 🚧 planned — #95 static half, not yet implemented |
| TC-1404 | A source-provenance locus carrying the consumer-owned `ArtifactRef.digest` raw-byte string and the consumer-owned `NativeSource.revision` authority label is admitted, and neither member refuses as a malformed digest selection | Unit | P1 | FR-112-AC-6, FR-112-CON-4 | 🚧 planned — #95 static half, not yet implemented |
| TC-1405 | One producer object transmitted under two different wire member orders yields one identical digest `value`, because every canonical-object digest input is the FR-118 canonicalizer output for that object rather than the producer's own serializer | Property | P0 | FR-112-AC-7, FR-112-CON-2 | 🚧 planned — #95 static half, not yet implemented |
| TC-1406 | Producer model, component, endpoint, and relationship revisions are emitted under `filament-core-data/producer-object-revision-1` and native artifact and definition revisions under `quire-native/definition-revision-1`, both members mapping onto the pinned consumer `Revision`, and no third namespace is emitted | Unit | P0 | FR-113-AC-1, FR-113-CON-1 | 🚧 planned — #95 static half, not yet implemented |
| TC-1407 | A native definition revision offered under the producer-object namespace and a producer-object revision offered under the native definition namespace each refuse | Unit | P0 | FR-113-AC-2 | 🚧 planned — #95 static half, not yet implemented |
| TC-1408 | A bare revision string offered in place of a two-member revision the producer authors refuses and binds nothing | Unit | P0 | FR-113-AC-3, FR-113-CON-2 | 🚧 planned — #95 static half, not yet implemented |
| TC-1409 | A revision namespace outside the closed admissible vocabulary refuses, and one inside it that the configuration document does not declare as a selection refuses | Unit | P0 | FR-113-AC-4, FR-113-CON-5 | 🚧 planned — #95 static half, not yet implemented |
| TC-1410 | Two revisions sharing one `value` spelling under the two declared namespaces remain two distinct revisions, and a locus carrying the consumer-owned `NativeSource.revision` label and `ArtifactRef.digest` string is admitted rather than refused as a malformed revision | Unit | P1 | FR-113-AC-5, FR-113-AC-6, FR-113-CON-3, FR-113-CON-4 | 🚧 planned — #95 static half, not yet implemented |
| TC-1411 | One component record carries its identity, namespaced revision, canonical digest selection, locus, ownership, and inventory membership as six separate members that equal spelling never merges | Unit | P0 | FR-114-AC-1, FR-114-CON-3 | 🚧 planned — #95 static half, not yet implemented |
| TC-1412 | One endpoint record carries the same six members and additionally names its owning component identity, its type identity, its role, and its multiplicity, none reconstructed from another | Unit | P0 | FR-114-AC-1 | 🚧 planned — #95 static half, not yet implemented |
| TC-1413 | A repository, a component, a role, and an endpoint sharing one display name remain four distinct identities, and no component identity is reconstructed from a path, a package name, or a deployment name | Unit | P0 | FR-114-AC-1, FR-114-CON-1, FR-114-CON-2 | 🚧 planned — #95 static half, not yet implemented |
| TC-1414 | A component whose locus is absent refuses, and an endpoint whose locus names no formal document revision refuses, each with a blocking refusal naming the offending record and neither substituting a native source label for the formal revision | Unit | P0 | FR-114-AC-2, FR-114-CON-4 | 🚧 planned — #95 static half, not yet implemented |
| TC-1415 | A component outside a closed declared inventory refuses admission, while the same component under an explicitly incomplete inventory is admitted carrying the completeness member with the retained `unknown` disposition FR-110 owns | Integration | P0 | FR-114-AC-3, FR-114-CON-6 | 🚧 planned — #95 static half, not yet implemented |
| TC-1416 | A full locus carrying `source` with `refVersion`, `kind`, `authority`, `identity`, a namespaced revision, one raw-byte digest string and `wire`, plus `formal` and `span`, is admitted with its raw-byte digest string, while a component whose locus no declaration source document supplies refuses and no synthesized locus is emitted | Unit | P0 | FR-114-AC-4, FR-114-AC-5, FR-114-CON-5 | 🚧 planned — #95 static half, not yet implemented |
| TC-1417 | One relationship record carries its identity, namespaced revision, canonical digest, authored name, `semantics` category with direction, composite flag, lifecycle and ownership, and the owning model, profile, and configuration identities as separate members | Unit | P0 | FR-115-AC-1, FR-115-CON-4 | 🚧 planned — #95 static half, not yet implemented |
| TC-1418 | The `source` and `target` endpoint records of one relationship each carry their own `endpointIdentity`, `typeIdentity`, `role`, and `multiplicity` as independent members even when both name one type identity | Unit | P0 | FR-115-AC-1, FR-115-CON-3 | 🚧 planned — #95 static half, not yet implemented |
| TC-1419 | A self-relationship whose `source` and `target` name one type identity emits two independent endpoint records retaining their own endpoint identities, roles, and multiplicities | Unit | P0 | FR-115-AC-2 | 🚧 planned — #95 static half, not yet implemented |
| TC-1420 | A relationship whose `source` omits its role refuses, one whose `target` omits its multiplicity refuses, and an endpoint projection collapsing the two roles into one refuses with a named loss record carrying the relationship identity rather than a guessed value | Unit | P0 | FR-115-AC-3 | 🚧 planned — #95 static half, not yet implemented |
| TC-1421 | Each `source` and `target` endpoint record joins a declared FR-114 endpoint through its `endpointIdentity` and never through a coinciding type identity, role, or display name, and a `source` `endpointIdentity` naming no declared endpoint refuses naming the relationship | Integration | P0 | FR-115-AC-4, FR-115-AC-5, FR-115-CON-5 | 🚧 planned — #95 static half, not yet implemented |
| TC-1422 | A relationship identity is authored rather than reconstructed from a foreign key, a field, or a relationship instance, and the emitted record carries no population member and no relationship instance | Unit | P0 | FR-115-CON-1, FR-115-CON-2 | 🚧 planned — #95 static half, not yet implemented |
| TC-1423 | One selected pair of one producer object and one native artifact yields exactly one correspondence record whose five authored producer-object members, native selection, native definition closure, binding-relation identity, configuration provenance, and export mappings are separate readable members, and whose producer object carries no authored interface member | Compile | P0 | FR-116-AC-1, FR-116-CON-1 | 🚧 planned — #95 static half, not yet implemented |
| TC-1424 | A correspondence record whose export mapping names an export its producer object does not export refuses, and one naming an export owned by another correspondence's producer object refuses | Unit | P0 | FR-116-AC-2 | 🚧 planned — #95 static half, not yet implemented |
| TC-1425 | Changing the producer object selection or the native artifact selection while retaining the prior binding relation refuses | Unit | P0 | FR-116-AC-3 | 🚧 planned — #95 static half, not yet implemented |
| TC-1426 | A presentation-only native re-encoding is admitted only through a new native artifact selection and a new correspondence record, never through a digest substitution under the retained relation | Unit | P0 | FR-116-AC-3 | 🚧 planned — #95 static half, not yet implemented |
| TC-1427 | A correspondence record submitted without the configuration provenance that authorized its relation refuses, and one whose required native definition-closure identities are incomplete refuses | Unit | P0 | FR-116-AC-4, FR-116-AC-5 | 🚧 planned — #95 static half, not yet implemented |
| TC-1428 | Two correspondence records naming one selected pair refuse, and a producer object the consumer does not select yields no correspondence record | Unit | P0 | FR-116-AC-6, FR-116-AC-7, FR-116-CON-4 | 🚧 planned — #95 static half, not yet implemented |
| TC-1429 | Every emitted export mapping carries its exporting producer object identity, its `exportKind` from the consumer's closed vocabulary, its ordered `exportPath` segments, and its formal export locus, the record carries no consumer table index and no producer-object interface index, and no export kind FR-120 partitions to the assessment side is emitted | Unit | P0 | FR-116-AC-8, FR-116-AC-9, FR-116-CON-2 | 🚧 planned — #95 static half, not yet implemented |
| TC-1430 | A producer canonical digest selection and a native raw-byte digest selection stay distinct members when their hash text coincides, and every consumer `u32` table index including the producer-object interface index is left unassigned | Static | P1 | FR-116-CON-3, FR-116-CON-5 | 🚧 planned — #95 static half, not yet implemented |
| TC-1431 | A complete static selection is admitted as one immutable typed bundle whose bundle identity, namespaced revision, canonical digest selection, producer interface version, model, profile, component and endpoint declarations, relationship records, inventory declaration, configuration document, static prerequisite closure, and correspondence records are each read directly as typed members | Unit | P0 | FR-117-AC-1 | 🚧 planned — #95 static half, not yet implemented |
| TC-1432 | The admitted static bundle carries no population, snapshot, window, instance, observation, progress record, or observation closure, and the bundle type is closed over exactly the declared content member classes and that exclusion and over no header member | Compile | P0 | FR-117-AC-1, FR-117-CON-1 | 🚧 planned — #95 static half, not yet implemented |
| TC-1433 | A bundle omitting any required member, whether a header member, an identity, a namespaced revision, a digest selection, a provenance locus, an ownership member, an inventory membership, or the static prerequisite closure, is refused and the refusal names the absent member | Unit | P0 | FR-117-AC-2 | 🚧 planned — #95 static half, not yet implemented |
| TC-1434 | An assessment member offered inside the static bundle refuses naming that member, an assessment document offered in place of a static admission refuses naming that document, and a correspondence export of the assessment kind FR-120 partitions to the assessment side refuses naming that export | Unit | P0 | FR-117-AC-3, FR-117-AC-7 | 🚧 planned — #95 static half, not yet implemented |
| TC-1435 | The static bundle type exposes no public constructor, no public member, and no deserialization path that bypasses admission, so no unvalidated value of the type can be constructed and a refused admission yields no value | Compile | P0 | FR-117-AC-4, FR-117-CON-2 | 🚧 planned — #95 static half, not yet implemented |
| TC-1436 | A static admission run with altered environment variables, an altered working directory, an altered wall clock, and no network reachability produces the identical admitted bundle | Integration | P0 | FR-117-AC-5, FR-117-CON-3 | 🚧 planned — #95 static half, not yet implemented |
| TC-1437 | Every member of an admitted static bundle is read without parsing prose, defaulting a member, or inferring a field, and production of the bundle is recorded as static admission only rather than as campaign acceptance of any assessment claim | Manual | P1 | FR-117-AC-6, FR-117-AC-9 | 🚧 planned — #95 static half, not yet implemented |
| TC-1438 | A static admission completes from the static members of the FR-109 configuration document and the FR-110 inventory declaration alone, reaching no FR-108 population obligation, with the configuration's static prerequisite closure and the FR-116 native definition closure kept distinct members carrying distinct refusals | Integration | P0 | FR-117-AC-8, FR-117-CON-4, FR-117-CON-5 | 🚧 planned — #95 static half, not yet implemented |
| TC-1439 | Two bundles carrying one bundle identity and one namespaced revision with different canonical digest selections refuse as an identity collision naming both, re-admitting one bundle identity over different bytes yields a different admitted-bundle key with a prior binding refused as stale rather than resolved forward, and the bundle header identity, revision, and digest stay distinct from the model's and the profile's | Integration | P0 | FR-117-AC-10, FR-117-AC-11, FR-117-CON-6, FR-117-CON-7 | 🚧 planned — #95 static half, not yet implemented |
| TC-1440 | The JSON numbers `1`, `1.0`, and `1e0` canonicalize to the single byte string `1` and agree on one `filament-canonical-json-1` digest | Unit | P0 | FR-118-AC-1 | 🚧 planned — #95 static half, not yet implemented |
| TC-1441 | The adjacent integers `9007199254740992` and `9007199254740993` canonicalize to different byte strings and therefore to different digests | Unit | P0 | FR-118-AC-2 | 🚧 planned — #95 static half, not yet implemented |
| TC-1442 | A decimal carrying more significant digits than binary64 represents exactly round-trips to the same arbitrary-precision coefficient and exponent, and no numeric value is represented as a binary floating-point value at any point between parsing and serialization | Property | P0 | FR-118-AC-3, FR-118-CON-1 | 🚧 planned — #95 static half, not yet implemented |
| TC-1443 | An object whose keys differ in locale collation order and in encoded byte length from their Unicode scalar-value order canonicalizes in Unicode scalar-value order, sorted by the canonicalizer itself rather than by a map implementation's iteration order | Unit | P0 | FR-118-AC-4, FR-118-CON-2, FR-118-CON-5 | 🚧 planned — #95 static half, not yet implemented |
| TC-1444 | A string containing a quote, a backslash, U+0000, and U+001F canonicalizes with the quote and backslash escaped and each control character as a lowercase `\u00xx` escape, while a document carrying a string that is not valid Unicode refuses with a blocking refusal and digests nothing | Unit | P0 | FR-118-AC-5, FR-118-AC-6 | 🚧 planned — #95 static half, not yet implemented |
| TC-1445 | Two documents differing only in the member order of one set array digest identically, two documents differing only in the member order of one semantic-order array digest differently, and a set array's membership stays a separate declaration from a semantic-order array's order | Property | P0 | FR-118-AC-7, FR-118-CON-3 | 🚧 planned — #95 static half, not yet implemented |
| TC-1446 | A number exceeding the configuration document's declared `maximumCoefficientDigits` or `maximumExponentMagnitude` refuses before canonicalization with neither a rounded nor a substituted binary64 value, and a configuration document declaring no `numericResourceLimit` member refuses naming that absent member with no host-chosen limit applied in its place | Unit | P0 | FR-118-AC-8, FR-118-AC-12, FR-118-CON-7 | 🚧 planned — #95 static half, not yet implemented |
| TC-1447 | A document assembled in an insertion-order-preserving map canonicalizes in Unicode scalar-value order with a permuted iteration order changing no byte, and a document whose members arrive in the consumer wire member order `domain, version, algorithm, value` canonicalizes to the emitted byte string and recomputes the declared digest | Unit | P0 | FR-118-AC-9, FR-118-AC-10, FR-118-CON-6 | 🚧 planned — #95 static half, not yet implemented |
| TC-1448 | One configuration document's declared `numericResourceLimit` refuses the same numbers and admits the same numbers on each architecture of the set NFR-036 names, so no admit-versus-refuse decision differs by host | Integration | P0 | FR-118-AC-11 | 🚧 planned — #95 static half, not yet implemented |
| TC-1449 | An object's own digest member is excluded from the canonical bytes that object digests, and this exclusion is applied only here rather than restated by a digest consumer | Unit | P0 | FR-118-CON-4 | 🚧 planned — #95 static half, not yet implemented |
| TC-1450 | Every digested document of one admitted static bundle canonicalizes to the same byte string and digest across two runs in one process and two runs in two separate processes, and to the committed golden byte string | Snapshot | P0 | NFR-036 | 🚧 planned — #95 static half, not yet implemented |
| TC-1451 | Every digested document's digest is unchanged when its object keys and set-array members are supplied in a permuted insertion order, over the declared permutation set, one paired run per permutation | Property | P0 | NFR-036 | 🚧 planned — #95 static half, not yet implemented |
| TC-1452 | Every digested document's canonical byte string, and every admit-versus-refuse decision under one configuration document's declared `numericResourceLimit`, agrees across `x86_64-unknown-linux-gnu` and `aarch64-unknown-linux-gnu` against one committed golden | Snapshot | P0 | NFR-036 | 🚧 planned — #95 static half, not yet implemented |
| TC-1453 | Every digested document's canonical byte string agrees across a changed locale, environment, and working directory against the same committed golden | Snapshot | P0 | NFR-036 | 🚧 planned — #95 static half, not yet implemented |
| TC-1454 | The declared numeric-path population reaches zero binary floating-point coercion sites between parsing and serialization, and the audit fails on a scratch copy carrying a planted float conversion | Static | P0 | NFR-036 | 🚧 planned — #95 static half, not yet implemented |
| TC-1455 | Every semantic-order array is emitted in the producer-declared order, measured per array against that declaration, with a permuted-array paired run whose digest must differ | Property | P0 | NFR-036 | 🚧 planned — #95 static half, not yet implemented |
| TC-1456 | Canonicalizing an admitted static bundle reads zero locales, environment variables, working directories, clocks, and sockets with no exemption, measured by call-graph analysis and by an instrumented offline run in an unprivileged network namespace | Static | P0 | NFR-036 | 🚧 planned — #95 static half, not yet implemented |
| TC-1457 | A population, a snapshot, and a window document are each emitted carrying their own stable identity, namespaced revision, canonical digest selection, and authorizing configuration selection as four separate typed members | Unit | P0 | FR-119-AC-1, FR-119-CON-1 | 🚧 planned — #95 assessment half, not in this increment |
| TC-1458 | An observation-record and an availability document each carry the same four members read directly with none absent, defaulted, or inferred, and a document identity stays separate from its revision value, its digest value, and any display name | Unit | P0 | FR-119-AC-1, FR-119-CON-2 | 🚧 planned — #95 assessment half, not in this increment |
| TC-1459 | An assessment document carrying no digest selection member, one carrying no revision member, and one carrying no configuration selection each refuse naming the absent member, two documents sharing one identity under one revision refuse as an identity collision rather than merging, and an inadmissible value inside a present digest or revision is left to FR-112 and FR-113 | Unit | P0 | FR-119-AC-2, FR-119-AC-3, FR-119-AC-4, FR-119-AC-5 | 🚧 planned — #95 assessment half, not in this increment |
| TC-1460 | A refused assessment document yields no value of its type, and no public constructor, no public member, and no deserialization path reaches an assessment document its admission operation did not validate | Compile | P0 | FR-119-AC-7, FR-119-CON-5, FR-119-CON-6 | 🚧 planned — #95 assessment half, not in this increment |
| TC-1461 | An assessment document exceeding a document-level bound declared in the authorizing configuration's `resourceLimits` refuses naming the exceeded bound and its declared value, with every bound read from that member rather than from the host, the build target, or a pointer width | Unit | P0 | FR-119-AC-8, FR-119-CON-7 | 🚧 planned — #95 assessment half, not in this increment |
| TC-1462 | A snapshot is addressed under the consumer's `snapshot` artifact kind and an observation record under its `observation` artifact kind, a population export under its `population` export kind, and a window selection against its `clock` binding kind, while a population and an availability document are each named by identity and canonical digest selection rather than given an artifact kind the pinned contract does not carry, the producer minting no vocabulary member of its own, owning no per-kind content obligation, and restating neither the FR-112 digest nor the FR-113 revision vocabulary | Unit | P0 | FR-119-AC-6, FR-119-AC-9, FR-119-AC-10, FR-119-CON-3, FR-119-CON-4, FR-119-CON-8 | 🚧 planned — #95 assessment half, not in this increment |
| TC-1463 | An assessment document names exactly one admitted static bundle by its identity and its admitted canonical digest selection, carried as two separate typed members, and binds against that bundle | Unit | P0 | FR-120-AC-1, FR-120-CON-1 | 🚧 planned — #95 assessment half, not in this increment |
| TC-1464 | Every component, endpoint, and relationship identity an assessment document names resolves from the bound bundle's export records and every object and type identity from that bundle's selected model's exported type identities, and from no record class the static half does not declare | Integration | P0 | FR-120-AC-1, FR-120-CON-8 | 🚧 planned — #95 assessment half, not in this increment |
| TC-1465 | An assessment document whose named bundle carries a canonical digest selection differing from the admitted bundle's refuses as a stale static selection, one naming a bundle never admitted refuses naming it, and one naming an identity absent from the bound bundle's export records or from its selected model's exported type identities refuses naming that identity and the vocabulary it was resolved against | Unit | P0 | FR-120-AC-2, FR-120-AC-3, FR-120-AC-4 | 🚧 planned — #95 assessment half, not in this increment |
| TC-1466 | A changed static selection yields a new assessment document with no existing document edited to carry it, and an assessment document whose configuration selection differs from the bound static bundle's refuses naming both selections under the single `resourceLimits` spelling this interface reads | Unit | P0 | FR-120-AC-6, FR-120-AC-9, FR-120-CON-5, FR-120-CON-6, FR-120-CON-7 | 🚧 planned — #95 assessment half, not in this increment |
| TC-1467 | A `population` correspondence export is admitted on an assessment document and names its owning document while the same export kind inside a static bundle stays refused under FR-117-AC-7, a static-side export kind on an assessment document refuses naming it, an assessment document offered where a static admission is expected is refused under FR-117-AC-3 alone, and an admitted static bundle names no assessment document, exposes no member that could, and completes admission with none present | Compile | P0 | FR-120-AC-5, FR-120-AC-7, FR-120-AC-8, FR-120-AC-10, FR-120-CON-2, FR-120-CON-3, FR-120-CON-4 | 🚧 planned — #95 assessment half, not in this increment |
| TC-1468 | A population document carrying its declared `closedWorld` value, its `declaredObjectUniverse` member, and a finite enumerable `members` set is emitted with each member's `objectIdentity`, `typeIdentity`, field-member states, and relationship-instance endpoint identities read directly as typed members, and with no open, streamed, or query-completed membership | Unit | P0 | FR-121-AC-1, FR-121-CON-1, FR-121-CON-6 | 🚧 planned — #95 assessment half, not in this increment |
| TC-1469 | A member whose `objectIdentity` lies outside a closed-world population's `declaredObjectUniverse` refuses naming that identity, a closed-world document carrying no `declaredObjectUniverse` member refuses naming that absent member rather than being admitted as open-world, and a member whose `typeIdentity` the bound bundle's selected model does not export refuses naming that identity and the exported type vocabulary | Unit | P0 | FR-121-AC-2, FR-121-AC-3, FR-121-AC-9, FR-121-CON-4 | 🚧 planned — #95 assessment half, not in this increment |
| TC-1470 | A field-member state collapsing absence, explicit null, or a present value into another of the three refuses naming that field member, a relationship instance whose endpoint identity the document does not declare refuses naming that dangling identity, and two observations of one member object are emitted as two records never merged into one | Unit | P0 | FR-121-AC-4, FR-121-AC-5, FR-121-AC-6 | 🚧 planned — #95 assessment half, not in this increment |
| TC-1471 | A member whose source row supplies both a candidate field value and a foreign key is emitted with its authored `objectIdentity` reconstructed from neither, emission is recorded as an assessment document only rather than as campaign acceptance, and the field, population, and membership-versus-coverage semantics stay owned by FR-106 and FR-108 | Unit | P0 | FR-121-AC-7, FR-121-AC-8, FR-121-CON-2, FR-121-CON-3, FR-121-CON-5 | 🚧 planned — #95 assessment half, not in this increment |
| TC-1472 | A snapshot document carrying its `snapshotIdentity`, the one population it cuts, its `observedAt` instant, and its immutable membership digest selection is emitted with each member read directly as a typed member | Unit | P0 | FR-122-AC-1 | 🚧 planned — #95 assessment half, not in this increment |
| TC-1473 | An `event-position` window with integer `startInclusive` and `endExclusive` positions and a `fixed-sample` window with an exact `epoch`, an exact rational `period`, a declared `unit`, and integer sample indexes are each emitted and accepted, each paired only with its own family's coverage form and selecting from exactly one population or snapshot | Unit | P0 | FR-122-AC-2, FR-122-CON-1 | 🚧 planned — #95 assessment half, not in this increment |
| TC-1474 | A `timestamp` window with RFC 3339 UTC instants is emitted and accepted, and every coverage form in every declared clock family is half-open with an inclusive start and an exclusive end | Unit | P0 | FR-122-AC-2, FR-122-CON-2 | 🚧 planned — #95 assessment half, not in this increment |
| TC-1475 | A window declaring a coverage form of another clock family refuses naming the incompatible form, one selecting from two populations or from a population and a snapshot at once refuses naming the competing sources, and a `fixed-sample` `period` expressed as a binary floating-point value or carrying a zero or negative denominator refuses naming that period | Unit | P0 | FR-122-AC-3, FR-122-AC-4, FR-122-AC-6, FR-122-AC-11, FR-122-CON-3 | 🚧 planned — #95 assessment half, not in this increment |
| TC-1476 | Two observation records for one member object are emitted as two documents carrying two distinct `observationRecordIdentity` and two distinct `orderingPosition` members, a window carrying two records under one record identity or one ordering position refuses naming the collision, and window, population, snapshot, member-object, and observation-record identities stay separate members that equal spelling merges none of | Unit | P0 | FR-122-AC-8, FR-122-CON-4 | 🚧 planned — #95 assessment half, not in this increment |
| TC-1477 | A selection declared temporal or choreography-aware with no window refuses and constructs none while one carrying no such declaration is emitted without that property being derived from a clause, a protocol, or a clock; membership resolves only from listed exact object identities or the declared membership digest with a near match resolving into neither; an altered wall clock, database state, and reversed event order produce identical documents; and a `period` of one third digests as a numerator of `1` over a denominator of `3` with no decimal expansion | Property | P0 | FR-122-AC-5, FR-122-AC-7, FR-122-AC-9, FR-122-AC-10, FR-122-CON-5, FR-122-CON-6 | 🚧 planned — #95 assessment half, not in this increment |
| TC-1478 | An unavailable observation is emitted as its own availability fact carrying its `availabilityFactIdentity`, the exact affected observation-record identity, and its reason as separate members with no Boolean result member, while the declared population, snapshot, and window membership is unchanged and no false result appears | Unit | P0 | FR-123-AC-1, FR-123-CON-1, FR-123-CON-4 | 🚧 planned — #95 assessment half, not in this increment |
| TC-1479 | An availability fact whose observation-record identity lies inside and one whose identity lies outside the evaluator's declared exact admitted support set are emitted as the same fact with the same members, the emitting document carries the availability-incompleteness dimension in both cases, and no emitted member holds a truth disposition | Unit | P0 | FR-123-AC-2, FR-123-CON-2 | 🚧 planned — #95 assessment half, not in this increment |
| TC-1480 | An availability fact naming no observation-record identity, one naming an observation record the bound documents do not contain, one carrying no `availabilityFactIdentity`, a document representing an unavailable observation as an omitted membership rather than a fact, a document carrying a member that holds a truth disposition, and two facts of one document naming one observation-record identity each refuse naming the offending member, and no merged fact is emitted | Unit | P0 | FR-123-AC-3, FR-123-AC-4, FR-123-AC-5, FR-123-AC-6, FR-123-AC-8, FR-123-AC-9, FR-123-CON-5 | 🚧 planned — #95 assessment half, not in this increment |
| TC-1481 | Emission of an availability fact is recorded as a producer availability declaration only rather than as campaign acceptance, and the producer exposes no operation that decides a claim's truth | Manual | P1 | FR-123-AC-7, FR-123-CON-3 | 🚧 planned — #95 assessment half, not in this increment |
| TC-1482 | One selected pair of one producer assessment object and one native artifact yields exactly one assessment correspondence record whose five authored producer-object members, native selection, native definition closure, binding-relation identity, configuration provenance, and export mappings are separate readable members and which carries no authored interface member | Compile | P0 | FR-124-AC-1, FR-124-AC-7, FR-124-CON-1 | 🚧 planned — #95 assessment half, not in this increment |
| TC-1483 | Every exported population identity carries one export mapping with its exporting producer object identity, its `exportKind`, its ordered `exportPath` segments, and its formal export locus, and the emitted record assigns no consumer `u32` table index including the producer-object interface index | Unit | P0 | FR-124-AC-1, FR-124-AC-2, FR-124-CON-2, FR-124-CON-5 | 🚧 planned — #95 assessment half, not in this increment |
| TC-1484 | A snapshot document is addressed as a consumer artifact reference of kind `snapshot`, an observation-record document as one of kind `observation`, and a window selection as a binding requirement of kind `clock`, none of the three yielding an export mapping, and each satisfied `population`, `snapshot`, `clock`, and `observation` binding kind supplies the later inputs the consumer's binding-requirement record declares | Unit | P0 | FR-124-AC-3, FR-124-AC-4, FR-124-AC-5, FR-124-CON-6 | 🚧 planned — #95 assessment half, not in this increment |
| TC-1485 | An assessment export mapping whose `exportKind` lies on the static side of FR-120's partition refuses naming that export kind, a changed producer-object or native-artifact selection under a retained binding-relation identity refuses, an absent configuration provenance refuses, and a producer canonical and a native raw-byte digest selection stay distinct members when their hash text coincides | Unit | P0 | FR-124-AC-6, FR-124-AC-9, FR-124-CON-3, FR-124-CON-4 | 🚧 planned — #95 assessment half, not in this increment |
| TC-1486 | An assessment correspondence record whose export mapping names an export its producer object does not export refuses, one naming an export owned by another record's producer object refuses, and emission is recorded as a producer emission only rather than as campaign acceptance | Unit | P0 | FR-124-AC-8, FR-124-AC-9 | 🚧 planned — #95 assessment half, not in this increment |
| TC-1487 | A 1.2 document whose every authored presence equals the value a v1.1 reader derives and which carries no other 1.2-only member projects to v1.1 as a new document with its own identity, namespaced revision, and digest selection, leaving the projected document's identity, revision, and digest byte-unchanged and the two identities distinct | Unit | P0 | FR-125-AC-1, FR-125-AC-6, FR-125-CON-3 | 🚧 planned — #95 assessment half, not in this increment |
| TC-1488 | A 1.2 document carrying one field whose authored presence differs from the v1.1 derivation, one carrying a 1.2-only contract member with no v1.1 counterpart, and a v1.1 document offered as a 1.2 document each refuse with a blocking loss record that names every lost member individually rather than a count or a flag and carries the source document's exact identity, namespaced revision, and digest selection, yielding no projection document | Unit | P0 | FR-125-AC-2, FR-125-AC-3, FR-125-AC-5, FR-125-AC-7, FR-125-CON-4 | 🚧 planned — #95 assessment half, not in this increment |
| TC-1489 | A projection that passed only because a member of its source model, population, or document was rewritten refuses naming that member, the source is emitted unchanged, and the producer exposes no adapter, repair pass, or normalization step that edits an input so a refused projection passes | Unit | P0 | FR-125-AC-4, FR-125-CON-2 | 🚧 planned — #95 assessment half, not in this increment |
| TC-1490 | An admitted v1.1 projection declares the v1.1 wire schema identity and the v1.1 producer interface version, declares neither the 1.2 interface version nor `v1.1` as a model revision value, stands as a document set whose only member is that projection, is recorded as a projection only, and takes its authored-presence semantics from FR-106 and its unimplemented-target refusal from FR-126 | Unit | P0 | FR-125-AC-8, FR-125-AC-9, FR-125-CON-1, FR-125-CON-5, FR-125-CON-6 | 🚧 planned — #95 assessment half, not in this increment |
| TC-1491 | Every document of one emitted document set, static and assessment alike, carries `1.2.0` as one authored three-component `interfaceVersion` member and carries the `wireSchema` member holding the consumer wire schema identity, neither inferred from the document's shape, member set, or transport, and a document whose `wireSchema` member is absent refuses naming it | Unit | P0 | FR-126-AC-1, FR-126-AC-10, FR-126-CON-1, FR-126-CON-6 | 🚧 planned — #95 assessment half, not in this increment |
| TC-1492 | Two interface versions differing only in their patch component admit the same document set and make the same refusals over it, an incremented minor within one major admits every document the earlier minor admitted and declares its members plus only new ones with none removed, retyped, or narrowed, and a change that refuses a previously admitted document is carried only by an incremented major and refused under an incremented minor or patch | Unit | P0 | FR-126-AC-2, FR-126-AC-3, FR-126-AC-4, FR-126-CON-5 | 🚧 planned — #95 assessment half, not in this increment |
| TC-1493 | A document declaring an interface version the producer does not implement refuses naming that version and is read neither on a best-effort basis nor under the nearest known version, a document whose `interfaceVersion` member is absent refuses naming it with no version defaulted, and no comparison exists that orders an unknown interface version against a known one | Compile | P0 | FR-126-AC-5, FR-126-AC-6, FR-126-CON-3 | 🚧 planned — #95 assessment half, not in this increment |
| TC-1494 | A document set of exactly the documents one correspondence closure names whose members declare two different interface versions refuses naming both versions and the documents that declared them with no agreeing subset admitted, and a document that no correspondence closure of the set names refuses naming that document | Unit | P0 | FR-126-AC-7, FR-126-AC-11, FR-126-CON-4 | 🚧 planned — #95 assessment half, not in this increment |
| TC-1495 | A digest domain version, a model revision, and a wire schema identity each refuse when offered in place of the interface version, naming the substituted member and keeping the four version members distinct; a v1.1 projection declares the v1.1 interface version and wire schema identity, stands as its own document set, and yields no two-version refusal beside the 1.2 document it came from; and the declaration is recorded as an interface declaration only | Unit | P0 | FR-126-AC-8, FR-126-AC-9, FR-126-AC-12, FR-126-CON-2 | 🚧 planned — #95 assessment half, not in this increment |
| TC-1496 | One assessment document per bound-crossing case, sized one byte past the declared document byte bound, nested one level past the declared nesting-depth bound on each nesting axis, and carrying one member past each counted member-class bound, is refused with a blocking refusal naming that bound and no abnormal termination | Unit | P0 | NFR-037 | 🚧 planned — #95 assessment half, not in this increment |
| TC-1497 | Peak resident memory stays under four times the input byte size and the refusal decision is reached in under five seconds per document, measured and reported over the bounded-input probe set at and one past each declared bound under a resident-memory and wall-time cap | Benchmark | P1 | NFR-037 | 🚧 planned — #95 assessment half, not in this increment |
| TC-1498 | Refusal decisions over the bounded-input probe set agree across `x86_64-unknown-linux-gnu` and `aarch64-unknown-linux-gnu` against one committed decision golden, every enforced bound equals the configuration document's declared value and the value the refusal names, and no bound is enforced from a crate constant, an environment variable, a working directory, a wall clock, or a network read, with a planted host-derived bound as the control that the audit fails | Static | P0 | NFR-037 | 🚧 planned — #95 assessment half, not in this increment |
| TC-1499 | Fuzzing the assessment-document parse and admission surface from raw bytes and from the document grammar under a failing panic hook and the declared memory and time caps reaches zero abnormal terminations, and every structurally valid hostile document returns a result or a named refusal | Fuzz | P0 | NFR-037 | 🚧 planned — #95 assessment half, not in this increment |
...
| TC-1400, TC-1401 | digest class | `filament-canonical-json-1` version `1` or `quire-native-bytes-1` version `1` | canonical-object or native raw-byte digest | Each domain is accepted only for its own input; the other direction refuses rather than revalidating |
| TC-1406, TC-1407 | revision class | `filament-core-data/producer-object-revision-1` or `quire-native/definition-revision-1` | producer object or native definition revision | Each namespace admits only its own object class; substitution refuses |
| TC-1415 | inventory completeness | closed or explicitly incomplete | component admission | Closed refuses the outsider; explicitly incomplete admits it carrying FR-110's retained `unknown` |
| TC-1440 | decimal form | `1`, `1.0`, or `1e0` | Filament Canonical JSON 1 | One canonical byte string and one digest for all three |
| TC-1445 | array disposition | set membership or semantic order | canonical digest | Permuting a set array changes no digest; permuting a semantic-order array changes it |
| TC-1473, TC-1474 | clock family | `event-position`, `fixed-sample`, or `timestamp` | window coverage form | Each family pairs only with its own half-open coverage form; a mismatched form refuses |
| TC-1468, TC-1469 | population world | closed with `declaredObjectUniverse` or open | membership admission | Closed refuses an outside object identity; an absent universe member refuses rather than defaulting to open |
| TC-1487, TC-1488 | v1.1 projection | lossless or lossy | baseline projection | Lossless projects as a new document; lossy refuses with a blocking loss record naming every lost member |
| TC-1492 | interface-version increment | patch, minor, or major | admitted-document and refusal effects | Patch changes neither set; minor is additive only; a refusing change is carried only by major |
| TC-1462, TC-1484 | consumer vocabulary slot | artifact kind, export kind, or binding kind | assessment document addressing | `snapshot` and `observation` as artifact kinds, `population` as an export kind, a window as a `clock` binding requirement; no kind is minted |
...
| FR-093-AC-13 | Prohibited | Two fields whose `SCREAMING_FIELD` forms collide (`versionNumber`, `version_number`) each carrying `min` | TC-1334 | `DUPLICATE_CONSTRAINT` at the second row, blocking |
...
| FR-112-CON-3 | Allowed | A digest selection whose `version` is authored separately from its `domain` and selected by the configuration document | TC-1400, TC-1403 | Admitted |
| FR-112-CON-3 | Prohibited | A digest selection with no `version` member, the version to be read from the domain spelling | TC-1403 | Refuses |
| FR-112-CON-1 | Prohibited | A bare hash string offered as a binding digest | TC-1403 | Refuses and binds nothing |
| FR-113-CON-1 | Allowed | Exactly the two declared revision namespaces | TC-1406 | Admitted |
| FR-113-CON-1 | Prohibited | A third revision namespace, or a declared namespace the configuration does not select | TC-1409 | Refuses |
| FR-114-CON-4 | Allowed | A component locus naming the authored formal document revision | TC-1416 | Admitted |
| FR-114-CON-4 | Prohibited | A locus substituting a native source label for the formal document revision | TC-1414 | Refuses naming the offending record |
| FR-117-CON-1 | Allowed | Exactly the declared static content member classes | TC-1431, TC-1432 | Admitted |
| FR-117-CON-1 | Prohibited | Any assessment member class inside the static bundle | TC-1434 | Refuses naming the offered assessment member |
| FR-118-CON-7 | Allowed | A number at the configuration document's declared `maximumCoefficientDigits` and `maximumExponentMagnitude` | TC-1446 | Canonicalizes |
| FR-118-CON-7 | Prohibited | One digit or one exponent magnitude past the declared limit, or a configuration document declaring no `numericResourceLimit` | TC-1446 | Refuses before canonicalization with no rounded and no binary64 value, and applies no host limit |
| FR-119-CON-7 | Allowed | An assessment document at each declared `resourceLimits` bound | TC-1461, TC-1496 | Admitted |
| FR-119-CON-7 | Prohibited | One byte, one nesting level, or one member past a declared bound | TC-1461, TC-1496 | Refuses naming the exceeded bound and its declared value |
| FR-121-CON-6 | Allowed | A closed-world population carrying `declaredObjectUniverse` on the document | TC-1468 | Admitted |
| FR-121-CON-6 | Prohibited | A closed-world population with no `declaredObjectUniverse` member | TC-1469 | Refuses; never admitted as an open-world population |
| FR-122-CON-2 | Allowed | Half-open coverage with an inclusive start and an exclusive end in every declared clock family | TC-1474 | Admitted |
| FR-122-CON-2 | Prohibited | A closed or exclusive-start coverage form in any clock family | TC-1474 | Refuses |
| FR-122-CON-3 | Allowed | A `fixed-sample` `period` of `numerator` `1` over `denominator` `3` as arbitrary-precision base-10 integers | TC-1477 | Admitted and digested exactly, with no decimal expansion |
| FR-122-CON-3 | Prohibited | A `period` denominator of zero or a negative denominator, or a binary floating-point period | TC-1475 | Refuses naming that period |
| FR-126-CON-4 | Allowed | One interface version across exactly the documents one correspondence closure names | TC-1491 | Admitted |
| FR-126-CON-4 | Prohibited | Two interface versions inside one document set | TC-1494 | Refuses naming both versions and their documents; no agreeing subset admitted |
...
| complete static selection | indivisible static admission runs | admitted static bundle keyed by identity, namespaced revision and canonical digest selection | TC-1431, TC-1439 |
| admitted static bundle | one bundle identity is re-admitted over different bytes | a second admitted bundle under a different key; a binding naming the earlier bundle refuses as stale | TC-1439 |
| admitted static bundle | an assessment document names it by identity and admitted canonical digest selection | bound assessment document resolving its identities from that bundle's exports | TC-1463, TC-1464 |
| admitted static bundle | the named bundle's canonical digest selection has since changed | stale-selection refusal, never rebound to the current bundle | TC-1465 |
| bound assessment document | the static selection changes | a new assessment document; no existing assessment document is edited | TC-1466 |
| admitted static bundle | no population, snapshot or window exists at all | static link admitted with no observation requested | TC-1438, TC-1467 |
| 1.2 document with lossless authored presence | projection to v1.1 requested | a new v1.1 document with its own identity, revision and digest selection | TC-1487 |
| 1.2 document whose authored presence differs from the v1.1 derivation | projection to v1.1 requested | blocking loss record naming the field; no projection document | TC-1488 |
...
| ERR-261 | Two documents lower to `displayName` values with equal slugs, or two enumeration rows slug alike | `DUPLICATE_TYPE_NAME` at the second document or row naming both; blocking | TC-1334, TC-1347 |
...
| ERR-267 | A name slugs to the empty string | `UNSLUGGABLE_NAME` at the declaration; blocking | TC-1252 |
...
| ERR-290 | A canonical-object digest is offered under `quire-native-bytes-1`, or a native raw-byte digest under `filament-canonical-json-1` | Blocking refusal naming the selection; not revalidated in the other domain and not a cache miss | TC-1401 |
| ERR-291 | A digest selection's recomputed value differs from its declared value | Blocking refusal; not a warning and not a refetch invitation | TC-1402 |
| ERR-292 | A digest selection has an absent `version`, a domain or version outside the closed vocabulary, an admissible pair the configuration does not select, or is a bare hash string | Refusal that binds nothing | TC-1403 |
| ERR-293 | A revision is offered under the other declared namespace | Refusal | TC-1407 |
| ERR-294 | A bare revision string is offered as a binding revision, or a namespace lies outside the closed vocabulary or is undeclared by the configuration | Refusal that binds nothing | TC-1408, TC-1409 |
| ERR-295 | A component locus is absent, or an endpoint locus names no formal document revision | Blocking refusal naming the offending record | TC-1414 |
| ERR-296 | A component lies outside a closed declared inventory | Refusal of admission | TC-1415 |
| ERR-297 | A component's locus is supplied by no declaration source document | Blocking refusal naming the component; no synthesized locus emitted | TC-1416 |
| ERR-298 | A relationship endpoint omits its role or its multiplicity, or an endpoint projection collapses the two roles into one | Refusal with a named loss record carrying the relationship identity | TC-1420 |
| ERR-299 | A relationship endpoint's `endpointIdentity` names no declared endpoint | Blocking refusal naming the relationship | TC-1421 |
| ERR-300 | A correspondence export mapping names an export its producer object does not export, or one owned by another correspondence's producer object | Refusal | TC-1424 |
| ERR-301 | The producer-object or native-artifact selection changes while the prior binding relation is retained | Refusal; a re-encoding needs a new native artifact selection and a new record | TC-1425, TC-1426 |
| ERR-302 | A correspondence record omits the configuration provenance that authorized its relation, or its native definition-closure identities are incomplete | Refusal | TC-1427 |
| ERR-303 | Two correspondence records name one selected producer-object and native-artifact pair | Refusal | TC-1428 |
| ERR-304 | A static bundle omits a required header or content member | Refusal naming the absent member | TC-1433 |
| ERR-305 | An assessment member, an assessment-side export kind, or an assessment document is offered where a static admission is expected | Refusal naming the offered member, export or document; nothing silently retained | TC-1434 |
| ERR-306 | Two bundles carry one identity and revision with different canonical digest selections, or a binding names a superseded admitted bundle | Identity-collision or stale refusal naming both canonical digest selections | TC-1439 |
| ERR-307 | A canonical document carries a string that is not valid Unicode, a number past a declared numeric limit, or no `numericResourceLimit` member at all | Blocking refusal that digests nothing and substitutes no rounded, binary64 or host-chosen value | TC-1444, TC-1446 |
| ERR-308 | An assessment document carries no digest selection, no revision, or no configuration selection member | Refusal naming the absent member | TC-1459 |
| ERR-309 | Two assessment documents share one identity under one revision | Identity-collision refusal; the two are not merged | TC-1459 |
| ERR-310 | An assessment document exceeds a document-level bound declared in the authorizing configuration's `resourceLimits` | Refusal naming the exceeded bound and its declared value | TC-1461, TC-1496 |
| ERR-311 | An assessment document names a static bundle whose canonical digest selection differs from the admitted bundle's | Stale-static-selection refusal; never rebound to the current bundle | TC-1465 |
| ERR-312 | An assessment document names a static bundle that was never admitted | Refusal naming the unadmitted bundle | TC-1465 |
| ERR-313 | An assessment document names an identity absent from the bound bundle's export records, or an object or type identity absent from its selected model's exported type identities | Refusal naming that identity and the vocabulary it was resolved against | TC-1465 |
| ERR-314 | A bound assessment document and static bundle carry different configuration selections | Refusal naming both configuration selections | TC-1466 |
| ERR-315 | An assessment document carries a correspondence export whose kind is on the static side of FR-120's partition | Refusal naming that export kind | TC-1467, TC-1485 |
| ERR-316 | A closed-world population member lies outside `declaredObjectUniverse`, or a closed-world document carries no such member | Blocking refusal; never admitted as an open-world population | TC-1469 |
| ERR-317 | A population member's `typeIdentity` names a type the bound bundle's selected model does not export | Blocking refusal naming the type identity and the exported type vocabulary | TC-1469 |
| ERR-318 | A field-member state collapses absence, explicit null, or a present value into another of the three | Blocking refusal naming that field member | TC-1470 |
| ERR-319 | A relationship instance names an endpoint identity the population document does not declare | Blocking refusal naming the dangling endpoint identity | TC-1470 |
| ERR-320 | A window declares a coverage form belonging to another clock family | Blocking refusal naming the incompatible coverage form | TC-1475 |
| ERR-321 | A window selects from two populations, or from a population and a snapshot at once | Refusal naming the competing selection sources | TC-1475 |
| ERR-322 | A `fixed-sample` `period` is a binary floating-point value, or carries a zero or negative denominator | Blocking refusal naming that period | TC-1475 |
| ERR-323 | A window carries two observation records under one record identity or one ordering position | Refusal naming the collision | TC-1476 |
| ERR-324 | An availability fact carries no `availabilityFactIdentity`, no observation-record identity, or names an observation record the bound documents do not contain | Refusal naming the absent or unknown member | TC-1480 |
| ERR-325 | An unavailable observation is represented as a member omitted from population, snapshot or window membership, or two facts of one document name one observation record | Refusal naming the omitted member or both facts; no merged fact emitted | TC-1480 |
| ERR-326 | A document the producer would emit carries a member holding a truth disposition | Refusal naming that member | TC-1480 |
| ERR-327 | A projection's source carries an authored presence differing from the v1.1 derivation, or a 1.2-only member for which v1.1 declares no counterpart | Blocking loss record naming every lost member individually; no projection document | TC-1488 |
| ERR-328 | A projection passes only because a member of its source model, population or document was rewritten | Blocking refusal naming the rewritten member; the source is emitted unchanged | TC-1489 |
| ERR-329 | A document declares an interface version the producer does not implement, or carries no `interfaceVersion` or no `wireSchema` member | Refusal naming the version or the absent member; no best-effort read and no nearest-known version | TC-1491, TC-1493 |
| ERR-330 | A document set declares two interface versions, contains a document no correspondence closure names, or substitutes a digest domain version, a model revision or a wire schema identity for the interface version | Refusal naming both versions and their documents, the unnamed document, or the substituted member; no agreeing subset admitted | TC-1494, TC-1495 |
...
| EC-154 | Two documents whose titles differ only by case (`Status`, `status`) | FR-093, FR-095 | TC-1334, TC-1347 | Distinct `type/` identities mint colliding `field/`, `constraint/`, and `relationship/` identities |
| EC-170 | A repository, a component, a role and an endpoint that share one display name | FR-114 | TC-1413 | Four identities collapse into one and a binding resolves against an object nobody selected |
| EC-171 | A self-relationship whose `source` and `target` name one type identity | FR-115 | TC-1419 | One endpoint is reconstructed from the other and its own role and multiplicity are lost |
| EC-172 | One revision `value` spelling under both declared namespaces | FR-113 | TC-1410 | Two distinct revisions merge and a native definition is read as a producer object |
| EC-173 | A producer canonical digest and a native raw-byte digest whose hash text coincides | FR-116, FR-124 | TC-1430, TC-1485 | A cross-domain substitution passes as a cache hit instead of refusing |
| EC-174 | A presentation-only native re-encoding of an already-bound native artifact | FR-116 | TC-1426 | The digest is substituted under the retained binding relation instead of a new correspondence record |
| EC-175 | A component admitted under an explicitly incomplete inventory | FR-110, FR-114 | TC-1415 | The retained `unknown` disposition is resolved to closed, so the component is wrongly refused or silently admitted |
| EC-176 | `1`, `1.0` and `1e0` written for one declared value | FR-118 | TC-1440 | Three canonical byte strings and three digests stand for one value |
| EC-177 | The adjacent integers `9007199254740992` and `9007199254740993` | FR-118 | TC-1441 | A binary64 round trip merges the two and one digest covers both |
| EC-178 | A decimal carrying more significant digits than binary64 represents exactly | FR-118 | TC-1442 | A digit is rounded and the canonical bytes become a property of the host |
| EC-179 | An insertion-order-preserving map, and the consumer's wire member order on the same document | FR-118, NFR-036 | TC-1447, TC-1451 | The walk order reaches the bytes and a transmission order becomes a digest input |
| EC-180 | One bundle identity re-admitted over different bytes | FR-117 | TC-1439 | A prior binding follows the identity forward and the result describes a subject nobody chose |
| EC-181 | A static admission attempted with no population, snapshot or window in existence | FR-117, FR-120 | TC-1438, TC-1467 | An observation becomes a prerequisite of recognition, so static linking requires minting inputs no one observed |
| EC-182 | Two observations of one member object | FR-121, FR-122 | TC-1470, TC-1476 | The two records merge and one ordering position stands for both |
| EC-183 | Two availability facts naming one observation record | FR-123 | TC-1480 | The facts merge and one reason is lost |
| EC-184 | A `fixed-sample` `period` of one third | FR-122 | TC-1477 | A decimal expansion is emitted and digested and the period stops being exact |
| EC-185 | An observation the producer could not obtain, outside the evaluator's declared admitted support | FR-123 | TC-1479 | The producer asserts a truth disposition instead of declaring an availability fact |
| EC-186 | A window supplied against the `clock` binding kind because no consumer export or artifact kind carries a window | FR-119, FR-124 | TC-1462, TC-1484 | A window is minted under an invented kind, or the selection is dropped |
| EC-187 | A population document named by identity and canonical digest because no consumer artifact kind admits one | FR-119, FR-124 | TC-1462, TC-1484 | A population document is given an artifact kind the pinned consumer contract does not carry |
| EC-188 | A v1.1 projection emitted beside the 1.2 document it was projected from | FR-125, FR-126 | TC-1490, TC-1495 | The pair reads as one two-version document set and refuses, or `v1.1` is written as a model revision value |
| EC-189 | Two interface versions differing only in their patch component | FR-126 | TC-1492 | A patch increment changes an admission or a refusal and the classification stops being a contract |
| EC-190 | An assessment document one byte, one nesting level and one member past each declared bound | NFR-037 | TC-1496, TC-1498 | A bound is enforced from a crate constant and two hosts disagree on which documents exist at all |
...
The Producer interface 1.2.0 rows are a mapping, not evidence. All 100 of
TC-1400..1499 are open: none is bound to a test, none has been measured, and the
shipped `crates/baseline-producer` contradicts the design in every respect
SR-213 recorded as Plan-017 work. The static half TC-1400..1456 is the increment
under implementation and its rows flip only as Plan-017 lands them; the
assessment half TC-1457..1499 is deliberately unimplemented here and stays
planned until a later increment takes it. Two gates SR-213 named remain unmet
and no row claims them. FND-1880 is an external dependency on the consumer's
repository — no consumer artifact kind admits a population document and no kind
carries a `window` member — which TC-1462, TC-1484, EC-186 and EC-187 record as
the route the design takes around it rather than as a defect closed here.

## Test Execution Summary

| Category | Total | Passed | Failed | Blocked | Coverage |
|---|---|---|---|---|---|
| Static | 274 | 233 | 0 | 41 | 100% mapped (274/274) |
| Manual | 50 | 45 | 0 | 5 | 100% mapped (50/50) |
| Analysis | 47 | 29 | 0 | 18 | 100% mapped (47/47) |
| Property | 134 | 71 | 0 | 63 | 100% mapped (134/134) |
| Unit | 559 | 393 | 0 | 166 | 100% mapped (559/559) |
| Integration | 137 | 81 | 0 | 56 | 100% mapped (137/137) |
| Fuzz | 14 | 8 | 0 | 6 | 100% mapped (14/14) |
| Snapshot | 70 | 34 | 0 | 36 | 100% mapped (70/70) |
| Compile | 22 | 4 | 0 | 18 | 100% mapped (22/22) |
| E2E | 12 | 12 | 0 | 0 | 100% mapped (12/12) |
| Benchmark | 1 | 0 | 0 | 1 | 100% mapped (1/1) |
| **Total** | **1320** | **910** | **0** | **410** | **100% mapped (1320/1320)** |
...
**Producer interface 1.2.0 status: 🚧 mapped, not executed.** The hundred rows
TC-1400..1499 add no passing result to the line above: every one of them is
`🚧 planned` and none is bound to a test. TC-1400..1456 are the static half being
implemented now, and TC-1457..1499 are the assessment half this increment does
not implement. The `Blocked` column therefore counts all 100, and it is meant to
— a `✅` on an unimplemented producer row would be the one thing this matrix
exists to prevent.
