...
- Field presence authored independently of multiplicity and carried as
  `Field.presence` in the semantic IR.
...
| Functional | [FR-001](./functional/FR-001-indexed-architecture-record.md) through [FR-106](./functional/FR-106-author-field-presence-independently.md) | Architecture, census, feasibility, semantic IR and field presence, package, mapping, generation, compiler, backend, semantic-kernel, and extraction-frontend behavior |
