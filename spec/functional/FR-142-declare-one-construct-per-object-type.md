...
- The Rust reader SHALL raise `UNRESOLVED_CONSTRUCT_REF` for a reference member entry naming no declared type, and for a member naming no declared state, operation or field.
