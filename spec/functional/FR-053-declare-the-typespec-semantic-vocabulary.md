...
- The frontend SHALL mint identities by the rules of FR-034, rooted at the package identity rather than at `<org>/<repo>`: `ix://<package identity>/type/<Name>`, `.../field/<Name>-<field>`, `.../field/<Name>-<operation>-<param>`, `.../variant/<Name>-<member>`, `.../relationship/<Name>-<verb>-<TargetName>`, `.../operation/<Name>-<name>`, `.../clause/<Name>-<clauseId>`, `.../constraint/<Name>-<field>-<keyword>` for a field constraint, `.../constraint/<Name>-<keyword>` for a type constraint, `.../type/<Name><Field>` for the alias a constrained property mints, and `.../type/<KernelScalar>` for a kernel scalar definition.
