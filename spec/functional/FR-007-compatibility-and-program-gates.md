...
- Until its named capability matrix passes, the TypeSpec decision SHALL remain
  provisional.
- The TypeSpec decision SHALL name modular JSON Schema 2020-12 as the fallback.
...
| FR-007-AC-2 | The TypeSpec pass/fail criteria and JSON Schema fallback are explicit. | Inspection (TC-026) |
