...
2.0.0 is the only contract, and the two v1 fixtures that used to declare a
deleted contract (`semantic-ir.json`, `config-version-v1-1.json`) are deleted
with it, not kept as refused negative evidence).
