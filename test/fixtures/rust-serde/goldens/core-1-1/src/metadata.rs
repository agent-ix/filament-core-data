//! Contract metadata, emitted beside the types it belongs to.
//!
...
const NODE_RELATIONSHIPS: &[RelationshipMeta] = &[crate::metadata::RelationshipMeta {
...
const ROOT_RELATIONSHIPS: &[RelationshipMeta] = &[crate::metadata::RelationshipMeta {
...
const ROOT_OP_RESIZE_PARAMS: &[ParamMeta] = &[crate::metadata::ParamMeta {
...
const ROOT_OPERATIONS: &[OperationMeta] = &[crate::metadata::OperationMeta {
    identity: "ix://agent-ix/conformance/operation/root-resize",
    name: "resize",
    params: ROOT_OP_RESIZE_PARAMS,
    returns: Some(crate::metadata::ReturnMeta {
...
pub const OCCURRENCES: &[OccurrenceMeta] = &[crate::metadata::OccurrenceMeta {
...
pub const PACKAGE_EXTENSIONS: &[ExtensionMeta] = &[crate::metadata::ExtensionMeta {
