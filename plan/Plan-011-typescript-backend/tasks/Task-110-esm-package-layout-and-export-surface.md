...
- [x] Emit the AGPL-3.0-only SPDX header and the generated-file banner on every file, and reconcile `package.json` and `LICENSE` in the output manifest under the package's own identity.
