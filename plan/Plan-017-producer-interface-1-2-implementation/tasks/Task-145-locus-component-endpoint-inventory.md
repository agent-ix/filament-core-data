...
- [x] **Red: record shape.** `tests/declarations.rs`: `tc_1611_` (one component
...
- [x] **Red: locus refusals.** `tc_1614_` (a component whose locus is absent
...
- [x] **Red: inventory.** `tc_1615_` (integration: a component outside a closed
...
- [x] **Green: locus.** `SourceLocus` with `Span { start: u32, end: u32 }`; the
  ...
  `DigestSelection`.
- [x] **Green: declarations.** `ComponentDeclaration { component_identity,
...
- [x] **Falsify.** Synthesize a locus from an unlocated declaration in a scratch
